...
return array(
	...
	'fields' => array(
		'ADDITIONAL_FIELDS' => array(
			...
			'METAOG_IMAGE' => 'https://repo.bitrix24.site/bitrix/images/demo/page/charity/preview.jpg',
	...
	<div class="light-theme u-header__section g-transition-0_3 g-py-15" data-header-fix-moment-exclude="light-theme g-py-15" data-header-fix-moment-classes="dark-theme u-shadow-v27 g-bg-white g-py-12">
			...
			<div class="container">
				...
				<a href="#" class="landing-block-node-menu-logo-link navbar-brand u-header__logo p-0">
					<img class="landing-block-node-menu-logo u-header__logo-img u-header__logo-img--main d-block g-max-width-180"
						 src="/bitrix/images/landing/logos/charity-logo-light.png" alt=""
					...
					<img class="landing-block-node-menu-logo2 u-header__logo-img u-header__logo-img--main d-none g-max-width-180"
						 src="/bitrix/images/landing/logos/charity-logo-dark.png" alt=""
				...
				<div class="collapse navbar-collapse align-items-center flex-sm-row" id="navBar">
					<ul class="landing-block-node-menu-list js-scroll-nav navbar-nav text-uppercase g-font-weight-700 g-font-size-11 g-pt-20 g-pt-0--lg ml-auto">
						<li class="landing-block-node-menu-list-item nav-item g-mr-10--lg g-mb-7 g-mb-0--lg active">
							<a href="#block@block[01.big_with_text_blocks_2]" class="landing-block-node-menu-list-item-link nav-link p-0" target="_self">HOME</a><span class="sr-only">(current)</span>
						</li>
	...
	<div class="js-carousel" data-infinite="1" data-fade="1" data-speed="5000" data-pagi-classes="u-carousel-indicators-v1 g-absolute-centered--x g-bottom-30">
		<div class="landing-block-node-card-block js-slide">
			<div class="landing-block-node-card-bgimg u-bg-overlay g-color-white g-bg-black-opacity-0_5--after g-bg-img-hero" style="background-image: url(https://cdn.bitrix24.site/bitrix/images/landing/business/1920x1280/img3.jpg);">
				<div class="u-bg-overlay__inner g-flex-centered g-height-100vh g-min-height-600 g-py-40">
					<div class="container">
						<h2 class="landing-block-node-card-title h2 text-uppercase g-line-height-1_2 g-letter-spacing-1 g-font-size-40 g-font-size-65--md g-color-white g-mb-40 js-animation slideInUp">
							For some,
						...
						<div class="landing-block-node-card-text g-max-width-800 g-color-white-opacity-0_7 g-mb-45 js-animation slideInUp">
						...
						<div>
							<a href="#" class="landing-block-node-card-link btn btn-xxl text-uppercase u-btn-primary g-font-weight-700 g-font-size-11 g-color-gray-dark-v1 g-color-gray-dark-v1--hover rounded-0 g-py-10 g-py-20--md g-px-15 g-px-25--md g-mr-10">
								Donate now</a>
							<a href="#" class="landing-block-node-card-link btn btn-xxl text-uppercase u-btn-primary g-font-weight-700 g-font-size-11 g-color-gray-dark-v1 g-color-gray-dark-v1--hover rounded-0 g-py-10 g-py-20--md g-px-15 g-px-25--md">Learn
								more</a>
						</div>
					</div>
				</div>
		...
		<div class="landing-block-node-card-block js-slide">
			<div class="landing-block-node-card-bgimg u-bg-overlay g-color-white g-bg-black-opacity-0_5--after g-bg-img-hero" style="background-image: url(https://cdn.bitrix24.site/bitrix/images/landing/business/1920x1280/img4.jpg);">
				<div class="u-bg-overlay__inner g-flex-centered g-height-100vh g-min-height-600 g-py-40">
					<div class="container">
						<h2 class="landing-block-node-card-title h2 text-uppercase g-line-height-1_2 g-letter-spacing-1 g-font-size-40 g-font-size-65--md g-color-white g-mb-40 js-animation slideInUp">
							For some,
						...
						<div>
							<a href="#" class="landing-block-node-card-link btn btn-xxl text-uppercase u-btn-primary g-font-weight-700 g-font-size-11 g-color-gray-dark-v1 g-color-gray-dark-v1--hover rounded-0 g-py-20 g-px-25 g-mr-10">
								Donate now</a>
							<a href="#" class="landing-block-node-card-link btn btn-xxl text-uppercase u-btn-primary g-font-weight-700 g-font-size-11 g-color-gray-dark-v1 g-color-gray-dark-v1--hover rounded-0 g-py-20 g-px-25">Learn
								more</a>
						</div>
					</div>
				</div>
			...
			<div class="col-lg-6">
				...
				<article class="row align-items-stretch text-center g-color-gray-dark-v5 g-bg-black mx-0">
					...
					<div class="landing-block-node-block col-sm-6 u-ns-bg-v1-bottom u-ns-bg-bottom u-ns-bg-v1-right--md g-bg-black g-px-30 g-py-45">
						<h3 class="landing-block-node-title text-uppercase g-font-size-20 g-color-white g-mb-25 js-animation flipInX">Became
							a
						...
						<div class="landing-block-node-button-container">
							<a class="landing-block-node-button btn btn-md text-uppercase u-btn-primary g-font-weight-700 g-font-size-11 g-color-gray-dark-v1 g-color-gray-dark-v1--hover rounded-0 g-py-10 g-px-25 js-animation fadeIn" href="#">Join Us</a>
						</div>
					</div>
					<!-- End Article Content -->
				...
				<div class="col-md-6 col-lg-4">
					...
					<article class="u-shadow-v19 landing-block-node-leftblock g-bg-primary js-animation fadeInLeft">
						...
						<div class="g-py-40 g-px-35">
							...
							<a class="landing-block-node-leftblock-button g-valign-middle btn btn-block text-uppercase u-btn-black g-font-size-11 g-font-weight-700 g-brd-none rounded-0 g-px-25 g-py-16" href="#">
								Donate Now
							</a>
						</div>
						<!-- End Article Content -->
	...
	<div class="container">
		...
		<div id="carouselCharity01" class="js-carousel g-pb-85 g-mx-minus-15" data-slides-show="2" data-arrows-classes="u-arrow-v1 g-pos-abs g-absolute-centered--x--md g-bottom-0 g-width-45 g-height-45 g-color-white g-color-black--hover g-bg-gray-light-v3 g-bg-primary--hover g-transition-0_2 g-transition--ease-in" data-arrow-left-classes="fa fa-chevron-left g-left-15 g-left-50x--md g-ml-minus-40--md" data-arrow-right-classes="fa fa-chevron-right g-right-15 g-left-50x--md g-ml-40--md">
			<div class="landing-block-node-card js-slide g-px-15">
				<!-- Article -->
				<article class="landing-block-node-card-bgimg clearfix g-bg-size-cover g-pos-rel" style="background-image: url(\'https://cdn.bitrix24.site/bitrix/images/landing/business/800x496/img4.jpg\');">
					<!-- Article Content -->
					<div class="landing-block-node-card-text-bg float-right g-color-gray-light-v1 g-bg-black-opacity-0_7 g-width-50x--sm g-pa-30">
						...
						<a class="btn landing-block-node-card-button g-valign-middle btn-block text-uppercase u-btn-primary g-font-weight-700 g-font-size-11 g-color-gray-dark-v1 rounded-0 g-py-10 g-py-20--md g-px-15 g-px-25--md js-animation fadeInLeft" href="#">
							Donate Now
						</a>
					</div>
					<!-- End Article Content -->
			...
			<div class="landing-block-node-card js-slide g-px-15">
				<!-- Article -->
				<article class="landing-block-node-card-bgimg clearfix g-bg-size-cover g-pos-rel" style="background-image: url(\'https://cdn.bitrix24.site/bitrix/images/landing/business/800x496/img5.jpg\');">
					<!-- Article Content -->
					<div class="landing-block-node-card-text-bg float-right g-color-gray-light-v1 g-bg-black-opacity-0_7 g-width-50x--sm g-pa-30">
						<h4 class="landing-block-node-card-title text-uppercase g-font-weight-700 h6 g-color-white g-mb-15 js-animation fadeInLeft">
							Water Project</h4>
			...
			<div class="landing-block-node-card js-slide g-px-15">
				<!-- Article -->
				<article class="landing-block-node-card-bgimg clearfix g-bg-size-cover g-pos-rel" style="background-image: url(\'https://cdn.bitrix24.site/bitrix/images/landing/business/800x496/img6.jpg\');">
					<!-- Article Content -->
					<div class="landing-block-node-card-text-bg float-right g-color-gray-light-v1 g-bg-black-opacity-0_7 g-width-50x--sm g-pa-30">
						<h4 class="landing-block-node-card-title text-uppercase g-font-weight-700 h6 g-color-white g-mb-15 js-animation fadeInLeft">
							Education Project</h4>
			...
			<div class="landing-block-node-card js-slide g-px-15">
				<!-- Article -->
				<article class="landing-block-node-card-bgimg clearfix g-bg-size-cover g-pos-rel" style="background-image: url(\'https://cdn.bitrix24.site/bitrix/images/landing/business/800x496/img7.jpg\');">
					<!-- Article Content -->
					<div class="landing-block-node-card-text-bg float-right g-color-gray-light-v1 g-bg-black-opacity-0_7 g-width-50x--sm g-pa-30">
						<h4 class="landing-block-node-card-title text-uppercase g-font-weight-700 h6 g-color-white g-mb-15 js-animation fadeInLeft">
							Water Project</h4>
...
',
	...
	<div class="container">
        ...
        <div class="container">
				<a class="landing-block-node-button btn btn-md text-uppercase u-btn-primary rounded-0 g-px-15 g-color-black-opacity-0_9" href="#" g-font-weight-700="" target="_self">BECOME A DONATOR</a>
        </div>
    </section>',
			),
	...
	<div class="container">
		...
		'35.2.footer_dark' =>
			array (
				...
				'SORT' => '8000',
				'CONTENT' => '<section class="g-color-gray-light-v1 g-py-60 g-bg-gray-dark-v1 g-pb-0">
	<div class="container">
		<div class="row">
