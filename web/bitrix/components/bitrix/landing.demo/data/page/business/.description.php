...
return array(
	...
	'fields' => array(
		'ADDITIONAL_FIELDS' => array(
			...
			'METAOG_IMAGE' => 'https://repo.bitrix24.site/bitrix/images/demo/page/business/preview.jpg',
	...
	'items' => array(
		'0.menu_05' =>
			array (
				'CODE' => '0.menu_05',
				'SORT' => '-100',
				'CONTENT' => '<header  class="landing-block landing-block-menu g-theme-business-bg-blue-dark-v1-opacity-0_9 u-header u-header--sticky-top u-header--change-appearance" data-header-fix-moment="100">
			...
			<div class="container">
				...
				<a href="#" class="navbar-brand landing-block-node-menu-logo-link u-header__logo">
					<img class="landing-block-node-menu-logo u-header__logo-img u-header__logo-img--main g-max-width-180"
						 src="/bitrix/images/landing/logos/business-logo.png" alt="">
				</a>
				<!-- End Logo -->
				...
				<div class="collapse navbar-collapse align-items-center flex-sm-row" id="navBar">
					<ul class="landing-block-node-menu-list js-scroll-nav navbar-nav text-uppercase g-letter-spacing-2 g-font-size-11 g-pt-20 g-pt-0--lg ml-auto">
						...
						<li class="nav-item landing-block-node-menu-list-item g-ml-15--lg">
							<a href="#block@block[04.2.one_col_fix_with_title_2]" class="landing-block-node-menu-list-item-link nav-link g-color-white p-0" target="_self">CONTACT</a>
						</li>
					</ul>
				</div>
				<!-- End Navigation -->
	...
	<div class="js-carousel g-overflow-hidden g-max-height-100vh" data-autoplay="true" data-infinite="true" data-fade="true" data-speed="5000">
		<div class="landing-block-card-img js-slide g-bg-img-hero g-height-100vh g-min-height-500--md" style="background-image: url(\'https://cdn.bitrix24.site/bitrix/images/landing/business/1600x1075/img1.jpg\');"></div>
		<div class="landing-block-card-img js-slide g-bg-img-hero g-height-100vh g-min-height-500--md" style="background-image: url(\'https://cdn.bitrix24.site/bitrix/images/landing/business/1600x1075/img2.jpg\');"></div>
	</div>
	...
	<div class="g-absolute-centered w-100">
            ...
            <div class="landing-block-node-center col-md-6 col-lg-4 g-flex-centered g-theme-business-bg-blue-dark-v1">
                <div class="text-center g-color-gray-light-v2 g-pa-30">
                    <div class="landing-block-node-header text-uppercase u-heading-v2-4--bottom g-brd-primary g-mb-40">
                        <h4 class="landing-block-node-center-subtitle h6 g-font-weight-800 g-font-size-12 g-letter-spacing-1 g-color-primary g-mb-20 js-animation fadeIn">About us</h4>
                        <h2 class="landing-block-node-center-title h1 u-heading-v2__title g-line-height-1_3 g-font-weight-600 g-font-size-40 g-color-white g-mb-minus-10 js-animation fadeIn">Help make
                            <br /> money</h2>
                    </div>
            ...
            <div class="col-md-6 col-lg-4 g-theme-business-bg-blue-dark-v2 landing-block-node-right">
                <div class="js-carousel g-pb-90" data-infinite="true" data-slides-show="true" data-pagi-classes="u-carousel-indicators-v1 g-absolute-centered--x g-bottom-30">
                    ...
                    <div class="js-slide landing-block-card-right">
                        ...
                        <div class="g-pa-30">
                            <h3 class="landing-block-node-right-title text-uppercase g-font-weight-700 g-font-size-20 g-color-white g-mb-10 js-animation fadeIn">Present 2018</h3>
                            <div class="landing-block-node-right-text g-color-gray-light-v2 js-animation fadeIn">
								<p>Etiam consectetur placerat gravida. Pellentesque ultricies mattis est, quis elementum neque pulvinar at.</p>
                            	<p>Aenean odio ante, varius vel tempor sed Ut condimentum ex ac enim ullamcorper volutpat. Integer arcu nisl, finibus vitae sodales vitae, malesuada ultricies sapien.</p>
							</div>
            ...
            <div class="row">
                    ...
                    <div class="landing-block-card-container g-pos-rel g-parent g-theme-business-bg-blue-dark-v2 g-py-35 g-px-25 g-pl-70--sm">
                        <div class="g-hidden-xs-down g-absolute-centered--y g-left-0">
                            <div class="g-pull-50x-left g-brd-around g-brd-5 g-brd-primary-dark-v3 g-rounded-50x g-overflow-hidden">
                                <span class="landing-block-node-element-icon-hover d-block g-pos-abs g-top-0 g-left-0 g-width-95 g-height-95 g-brd-around g-brd-5 g-brd-primary g-rounded-50x" style="background-image: url(https://cdn.bitrix24.site/bitrix/images/landing/business/100x100/img1.jpg);"></span>
								<span class="landing-block-node-element-icon-container u-icon-v3 u-icon-size--xl g-width-95 g-height-95 g-color-white g-bg-primary g-opacity-1 opacity-0--parent-hover g-transition-0_1 g-transition--ease-in">
								  <i class="landing-block-node-element-icon icon-fire"></i>
								</span>
                            </div>
                        </div>
                ...
                <div class="landing-block-card js-animation col-lg-6 g-px-30 g-mb-10 fadeIn">
                    <div class="landing-block-card-container g-pos-rel g-parent g-theme-business-bg-blue-dark-v2 g-py-35 g-px-25 g-pl-70--sm">
                        <div class="g-hidden-xs-down g-absolute-centered--y g-left-0">
                            <div class="g-pull-50x-left g-brd-around g-brd-5 g-brd-primary-dark-v3 g-rounded-50x g-overflow-hidden">
                                <span class="landing-block-node-element-icon-hover d-block g-pos-abs g-top-0 g-left-0 g-width-95 g-height-95 g-brd-around g-brd-5 g-brd-primary g-rounded-50x" style="background-image: url(https://cdn.bitrix24.site/bitrix/images/landing/business/100x100/img2.jpg);"></span>
								<span class="landing-block-node-element-icon-container u-icon-v3 u-icon-size--xl g-width-95 g-height-95 g-color-white g-bg-primary g-opacity-1 opacity-0--parent-hover g-transition-0_1 g-transition--ease-in">
								  <i class="landing-block-node-element-icon icon-energy"></i>
								</span>
                            </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="landing-block-card js-animation col-lg-6 g-px-30 g-mb-10 fadeIn animated landing-card">
                    <div class="landing-block-card-container g-pos-rel g-parent g-theme-business-bg-blue-dark-v2 g-py-35 g-px-25 g-pl-70--sm">
                        <div class="g-hidden-xs-down g-absolute-centered--y g-left-0">
                            <div class="g-pull-50x-left g-brd-around g-brd-5 g-brd-primary-dark-v3 g-rounded-50x g-overflow-hidden">
                                <span class="landing-block-node-icon-hover d-block g-pos-abs g-top-0 g-left-0 g-width-95 g-height-95 g-brd-around g-brd-5 g-brd-primary g-rounded-50x" style="background-image: url(https://cdn.bitrix24.site/bitrix/images/landing/business/100x100/img1.jpg);"></span>
								<span class="landing-block-node-element-icon-container u-icon-v3 u-icon-size--xl g-width-95 g-height-95 g-color-white g-bg-primary g-opacity-1 opacity-0--parent-hover g-transition-0_1 g-transition--ease-in">
                        ...
                        <h3 class="landing-block-node-title h5 text-uppercase g-color-gray-light-v2 g-mb-10">Step 1. Analisys</h3>
                        <div class="landing-block-node-text g-color-gray-light-v2">
							<p>Sed feugiat porttitor nunc, non dignissim ipsum vestibulum in. Donec in blandit dolor. Vivamus a fringilla lorem, vel faucibus ante.</p>
						</div>
                    </div>
                ...
                <div class="landing-block-card js-animation col-lg-6 g-px-30 g-mb-10 fadeIn animated landing-card">
                    <div class="landing-block-card-container g-pos-rel g-parent g-theme-business-bg-blue-dark-v2 g-py-35 g-px-25 g-pl-70--sm">
                        <div class="g-hidden-xs-down g-absolute-centered--y g-left-0">
                            <div class="g-pull-50x-left g-brd-around g-brd-5 g-brd-primary-dark-v3 g-rounded-50x g-overflow-hidden">
                                <span class="landing-block-node-icon-hover d-block g-pos-abs g-top-0 g-left-0 g-width-95 g-height-95 g-brd-around g-brd-5 g-brd-primary g-rounded-50x" style="background-image: url(https://cdn.bitrix24.site/bitrix/images/landing/business/100x100/img2.jpg);"></span>
								<span class="landing-block-node-element-icon-container u-icon-v3 u-icon-size--xl g-width-95 g-height-95 g-color-white g-bg-primary g-opacity-1 opacity-0--parent-hover g-transition-0_1 g-transition--ease-in">
                        ...
                        <h3 class="landing-block-node-title h5 text-uppercase g-color-gray-light-v2 g-mb-10">Step 2. Creative concept</h3>
                        <div class="landing-block-node-text g-color-gray-light-v2">
							<p>We strive to embrace and drive change in our industry which allows us to keep our clients relevant.</p>
						</div>
                    </div>
...
<!--            <div class="row align-items-stretch">-->
	...
	<div class="container text-center g-max-width-800 g-mb-20">
		...
		<div class="landing-block-node-inner text-uppercase u-heading-v2-4--bottom g-brd-primary">
			...
			<h2 class="landing-block-node-title u-heading-v2__title g-line-height-1_1 g-font-weight-700 g-font-size-40 g-color-black g-mb-minus-10">BEST OFFERS FOR YOU</h2>
		</div>

		<div class="landing-block-node-text g-color-gray-dark-v5 g-pb-1"><p>Sed feugiat porttitor nunc, non dignissim ipsum vestibulum in. Donec in blandit dolor. Vivamus a fringilla lorem, vel faucibus ante.Nunc ullamcorper, justo a iaculis elementum, enim orci viverra eros, fringilla porttitor lorem eros vel odio.</p></div>
	</div>
                    ...
                    <article class="text-center g-brd-around g-color-gray g-brd-gray-light-v5 g-pa-10">
                        <div class="g-bg-gray-light-v5 g-pa-30">
                            ...
                            <div class="g-color-primary g-my-20">
                                <div class="landing-block-node-price g-font-size-30 g-line-height-1_2"><strong>$25.00</strong></div>
                ...
                <div class="landing-block-card js-animation col-md-4 g-mb-30 g-mb-0--md fadeInUp">
                    <article class="text-center g-brd-around g-color-gray g-brd-gray-light-v5 g-pa-10 g-mt-minus-20">
                        <div class="g-bg-gray-light-v5 g-py-50 g-px-30">
                            ...
                            <div class="g-color-primary g-my-20">
                                <div class="landing-block-node-price g-font-size-30 g-line-height-1_2"><strong>$50.00</strong></div>
                                <div class="landing-block-node-price-text">per month</div>
                            </div>
                ...
                <div class="landing-block-card js-animation col-md-4 g-mb-30 g-mb-0--md fadeInUp">
                    <article class="text-center g-brd-around g-color-gray g-brd-gray-light-v5 g-pa-10">
                        <div class="g-bg-gray-light-v5 g-pa-30">
                            ...
                            <div class="g-color-primary g-my-20">
                                <div class="landing-block-node-price g-font-size-30 g-line-height-1_2"><strong>$75.00</strong></div>
                                <div class="landing-block-node-price-text">per month</div>
                            </div>
        ...
        <div class="landing-block-inner-container row no-gutters">
            ...
            <div class="landing-block-card col-md-12 col-lg-12 g-flex-centered js-animation fadeIn animated landing-card">
                <div class="text-center g-color-gray-light-v2 g-pa-30">
                    <div class="landing-block-node-card-header text-uppercase u-heading-v2-4--bottom g-brd-primary g-mb-40">
                        <h4 class="landing-block-node-subtitle h6 g-font-weight-800 g-font-size-12 g-letter-spacing-1 g-color-primary g-mb-20">FROM OUR BLOG</h4>
	...
	<div class="container">
        ...
        <div class="container">
            <div class="landing-block-node-inner text-uppercase text-center u-heading-v2-4--bottom g-brd-primary">
                ...
                <h2 class="landing-block-node-title h1 u-heading-v2__title g-line-height-1_3 g-font-weight-600 g-font-size-40 g-mb-minus-10">WHO WORK WITH US</h2>
            </div>
        </div>
    </section>',
			),
	...
	<div class="container g-max-width-800">
		<div class="landing-block-node-inner text-uppercase text-center u-heading-v2-4--bottom g-brd-primary">
			<h4 class="landing-block-node-subtitle h6 g-font-weight-800 g-font-size-12 g-letter-spacing-1 g-color-primary g-mb-20">CONTACT</h4>
		...
		'14.1.contacts_4_cols' =>
			array (
				...
				'SORT' => '8500',
				'CONTENT' => '<section class="landing-block landing-block-node-container g-theme-business-bg-blue-dark-v1">
        <div class="text-center g-color-gray-light-v2 g-py-40">

            <div class="container">
                <div class="row">
                    <div class="landing-block-card js-animation landing-block-node-contact g-brd-between-cols col-sm-3 g-px-15 g-py-30 g-py-0--md fadeIn">
                    ...
                    <div class="landing-block-card js-animation landing-block-node-contact g-brd-between-cols col-sm-3 g-brd-top g-brd-top-none--md g-brd-left--md g-brd-primary g-px-15 g-py-30 g-py-0--md fadeIn">
                    ...
                    <div class="landing-block-card js-animation landing-block-node-contact g-brd-between-cols col-sm-3 g-brd-top g-brd-top-none--md g-brd-left--md g-brd-primary g-px-15 g-py-30 g-py-0--md fadeIn">
                        <i class="landing-block-node-contact-img icon-earphones-alt d-inline-block g-font-size-50 g-color-primary g-mb-20"></i>
                        <h3 class="landing-block-node-contact-title text-uppercase g-font-size-default g-color-white-opacity-0_5 g-mb-5">Toll free</h3>
                        <div class="landing-block-node-contact-text g-font-size-default g-color-white">
							<span style="font-weight: bold;">@company24</span>
						</div>
                    </div>
                </div>
            </div>
