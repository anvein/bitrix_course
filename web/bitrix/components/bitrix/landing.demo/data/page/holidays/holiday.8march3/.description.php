...
return array(
	...
	'fields' => array(
		'ADDITIONAL_FIELDS' => array(
		    'METAOG_IMAGE' => 'https://repo.bitrix24.site/bitrix/images/demo/page/holidays/holiday.8march3/preview.jpg',
	...
	'items' => array (
		'0.menu_12_gym' =>
			array (
				'CODE' => '0.menu_12_gym',
				'SORT' => '-100',
				'CONTENT' => '<header class="landing-block landing-block-menu landing-ui-pattern-transparent u-header g-z-index-9999" data-header-fix-moment="100">
		...
		<nav class="navbar navbar-expand-lg g-py-0">
			<div class="container">
				...
				<a href="#" class="landing-block-node-menu-logo-link navbar-brand u-header__logo">
					<img class="landing-block-node-menu-logo u-header__logo-img u-header__logo-img--main g-max-width-180" src="/bitrix/images/landing/logos/gym-logo.png" alt="" />
				</a>
				<!-- End Logo -->
				...
				<div class="collapse navbar-collapse align-items-center flex-sm-row" id="navBar">
					<ul class="landing-block-node-menu-list js-scroll-nav navbar-nav text-uppercase g-letter-spacing-2 g-font-size-11 g-pt-20 g-pt-0--lg ml-auto">
						<li class="landing-block-node-menu-list-item nav-item g-mr-15--lg g-mb-7 g-mb-0--lg active">
							<a href="#block@block[01.big_with_text_blocks]" class="landing-block-node-menu-list-item-link nav-link p-0 g-color-white" target="_self">Home</a><span class="sr-only">(current)</span>
						</li>
						<li class="landing-block-node-menu-list-item nav-item g-mx-15--lg g-mb-7 g-mb-0--lg">
							<a href="#block@block[04.1.one_col_fix_with_title]" class="landing-block-node-menu-list-item-link nav-link p-0 g-color-white" target="_self">offers</a>
						</li>
						<li class="landing-block-node-menu-list-item nav-item g-mx-15--lg g-mb-7 g-mb-0--lg">
							<a href="#block@block[09.1.two_cols_fix_text_and_image_slider]" class="landing-block-node-menu-list-item-link nav-link p-0 g-color-white" target="_self">new items</a>
						</li>
						<li class="landing-block-node-menu-list-item nav-item g-mx-15--lg g-mb-7 g-mb-0--lg">
							<a href="#block@block[27.one_col_fix_title_and_text_2]" class="landing-block-node-menu-list-item-link nav-link p-0 g-color-white" target="_self">testimonials</a>
						</li>
						
						<li class="landing-block-node-menu-list-item nav-item g-mx-15--lg g-mb-7 g-mb-0--lg">
							<a href="#block@block[04.7.one_col_fix_with_title_and_text_2]" class="landing-block-node-menu-list-item-link nav-link p-0 g-color-white" target="_self">Contact</a>
						</li>
	...
	<div class="js-carousel g-overflow-hidden g-max-height-100vh " data-autoplay="true" data-infinite="true" data-speed="10000">
        ...
        <div class="row no-gutters g-overflow-hidden">
				...
				justify-content-center u-bg-overlay g-transition--ease-in g-transition-0_2 g-transform-scale-1_03--hover" style="background-image: url(\'https://cdn.bitrix24.site/bitrix/images/landing/business/900x506/img9.jpg\');" data-fileid="-1">
				...
				<div class="landing-block-card col-lg-6 landing-block-node-img g-min-height-500 g-bg-img-hero row no-gutters align-items-center
					justify-content-center g-bg-black-opacity-0_6--after u-bg-overlay g-transition--ease-in g-transition-0_2 g-transform-scale-1_03--hover" style="background-image: url(\'https://cdn.bitrix24.site/bitrix/images/landing/business/900x506/img10.jpg\');" data-fileid="-1">
					<div class="text-center u-bg-overlay__inner g-pa-40">
	...
	<div>
		...
		'21.1.four_cols_big_bgimg_title_text_button' =>
			array (
				...
				'CONTENT' => '<section class="landing-block container-fluid px-0">
        <div class="row no-gutters g-overflow-hidden">
                <div class="landing-block-card col-lg-2 landing-block-node-img g-min-height-350 g-bg-black-opacity-0_6--after g-bg-img-hero row no-gutters align-items-center
				justify-content-center u-bg-overlay g-transition--ease-in g-transition-0_2 g-transform-scale-1_03--hover" style="background-image: url(\'https://cdn.bitrix24.site/bitrix/images/landing/business/250x350/img1.jpg\');" data-fileid="-1">
					<div class="text-center u-bg-overlay__inner g-pa-40">
                ...
                <div class="landing-block-card col-lg-2 landing-block-node-img g-min-height-350 g-bg-black-opacity-0_6--after g-bg-img-hero row no-gutters align-items-center
				justify-content-center u-bg-overlay g-transition--ease-in g-transition-0_2 g-transform-scale-1_03--hover" style="background-image: url(\'https://cdn.bitrix24.site/bitrix/images/landing/business/250x350/img3.jpg\');" data-fileid="-1">
					<div class="text-center u-bg-overlay__inner g-pa-40">
            	...
            	<div class="landing-block-card col-lg-2 landing-block-node-img g-min-height-350 g-bg-black-opacity-0_6--after g-bg-img-hero row no-gutters align-items-center
				justify-content-center u-bg-overlay g-transition--ease-in g-transition-0_2 g-transform-scale-1_03--hover" style="background-image: url(\'https://cdn.bitrix24.site/bitrix/images/landing/business/250x350/img6.jpg\');" data-fileid="-1">
					<div class="text-center u-bg-overlay__inner g-pa-40">
            	...
            	<div class="landing-block-card col-lg-2 landing-block-node-img g-min-height-350 g-bg-black-opacity-0_6--after g-bg-img-hero row no-gutters align-items-center
				justify-content-center u-bg-overlay g-transition--ease-in g-transition-0_2 g-transform-scale-1_03--hover" style="background-image: url(\'https://cdn.bitrix24.site/bitrix/images/landing/business/250x350/img5.jpg\');" data-fileid="-1">
					<div class="text-center u-bg-overlay__inner g-pa-40">
            ...
            <div class="landing-block-card col-lg-2 landing-block-node-img g-min-height-350 g-bg-black-opacity-0_6--after g-bg-img-hero row no-gutters align-items-center justify-content-center u-bg-overlay g-transition--ease-in g-transition-0_2 g-transform-scale-1_03--hover landing-card" title="press to edit image" style="background-image: url(\'https://cdn.bitrix24.site/bitrix/images/landing/business/250x350/img2.jpg\');" data-fileid="-1">
					<div class="text-center u-bg-overlay__inner g-pa-40">
                        ...
                        <div class="landing-block-node-text g-color-white-opacity-0_7 g-font-open-sans js-animation fadeIn" title="press to edit text" style=""><p>Praesent malesuada facilisis maximus.</p></div>
                        <div class="landing-block-node-button-container">
                        	<a class="landing-block-node-button btn btn-lg u-btn-inset mx-2 g-rounded-50 u-btn-outline-white g-brd-0 js-animation fadeIn" href="#" target="_self" title="press to edit button" style="">view more</a>
                    	</div>
                    </div>
                <div class="landing-ui-panel landing-ui-panel-block-card-action landing-ui-size-lg landing-ui-show"><span class="landing-ui-button-text">&amp;nbsp;</span><span class="landing-ui-button-text landing-ui-hide-icon">&amp;nbsp;</span><div class="main-ui-loader main-ui-show" style="width: 16px; height: 16px;"></div></div></div><div class="landing-block-card col-lg-2 landing-block-node-img g-min-height-350 g-bg-black-opacity-0_6--after g-bg-img-hero row no-gutters align-items-center
				justify-content-center u-bg-overlay g-transition--ease-in g-transition-0_2 g-transform-scale-1_03--hover" style="background-image: url(\'https://cdn.bitrix24.site/bitrix/images/landing/business/250x350/img4.jpg\');" data-fileid="-1">
					<div class="text-center u-bg-overlay__inner g-pa-40">
