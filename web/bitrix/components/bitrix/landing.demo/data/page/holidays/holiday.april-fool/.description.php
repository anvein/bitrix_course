...
return array(
	...
	'fields' => array(
		'ADDITIONAL_FIELDS' => array(
		    'METAOG_IMAGE' => 'https://repo.bitrix24.site/bitrix/images/demo/page/holidays/holiday.april-fool/preview.jpg',
		...
		<nav class="navbar navbar-expand-lg p-0 g-px-15">
			<div class="container">
				...
				<a href="#" class="navbar-brand landing-block-node-menu-logo-link u-header__logo p-0">
					<img class="landing-block-node-menu-logo u-header__logo-img u-header__logo-img--main g-max-width-180" src="/bitrix/images/landing/logos/photography-logo.png" alt="" />
				</a>
				<!-- End Logo -->
...
></li>
						...
						<li class="landing-block-node-menu-list-item nav-item g-ml-25--lg">
							<a href="#block@block[35.1.footer_light]" class="landing-block-node-menu-list-item-link nav-link p-0 g-font-size-13" target="_self">Contact</a>
						</li>
					</ul>
				</div>
				<!-- End Navigation -->
