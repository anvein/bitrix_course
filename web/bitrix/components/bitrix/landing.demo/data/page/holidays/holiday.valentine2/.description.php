...
return array(
	...
	'fields' => array(
		'ADDITIONAL_FIELDS' => array(
		    'METAOG_IMAGE' => 'https://repo.bitrix24.site/bitrix/images/demo/page/holidays/holiday.valentine2/preview.jpg',
			'THEME_CODE' => 'travel',
		...
		<nav class="navbar navbar-expand-lg p-0 g-px-15">
			<div class="container">
				<a href="/" class="landing-block-node-menu-logo-link-small g-hidden-lg-up navbar-brand mr-0 p-0" target="_self">
					<img class="landing-block-node-menu-logo-small d-block g-max-width-180" src="/bitrix/images/landing/logos/valentine-logo-white.png" alt="" data-header-fix-moment-exclude="d-block" data-header-fix-moment-classes="d-none" />

					<img class="landing-block-node-menu-logo-small-2 d-none g-max-width-180" src="/bitrix/images/landing/logos/valentine-logo-black.png" alt="" data-header-fix-moment-exclude="d-none" data-header-fix-moment-classes="d-block" />
				</a>
				...
				<div class="collapse navbar-collapse align-items-center flex-sm-row" id="navBar">
					<ul class="landing-block-node-menu-list js-scroll-nav navbar-nav align-items-lg-center text-uppercase g-font-weight-700 g-font-size-11 g-pt-20 g-pt-0--lg mx-auto">
						<li class="landing-block-node-menu-list-item nav-item g-mr-30--lg g-mb-7 g-mb-0--lg active">
							<a href="#block@block[01.two_col_with_titles]" class="landing-block-node-menu-list-item-link nav-link g-color-white p-0">Home</a><span
 class="sr-only">(current)
						</span
></li>
						<li class="landing-block-node-menu-list-item nav-item g-mx-30--lg g-mb-7 g-mb-0--lg">
							<a href="#block@block[04.1.one_col_fix_with_title]" class="landing-block-node-menu-list-item-link nav-link g-color-white p-0">About</a>
						</li>
						<li class="landing-block-node-menu-list-item nav-item g-mx-30--lg g-mb-7 g-mb-0--lg">
							<a href="#block@block[21.3.two_cols_big_bgimg_title_text_button]" class="landing-block-node-menu-list-item-link nav-link g-color-white p-0">Services</a>
						</li>
						...
						<li class="g-hidden-md-down nav-logo-item g-mx-15--lg">
							<a href="#team" class="landing-block-node-menu-logo-link navbar-brand mr-0" target="_self">
								<img class="landing-block-node-menu-logo d-block g-max-width-180" src="/bitrix/images/landing/logos/valentine-logo-white.png" alt="" data-header-fix-moment-exclude="d-block" data-header-fix-moment-classes="d-none" data-filehash="1f93fef6cfc352d763bd97c358efc5d2" />

								<img class="landing-block-node-menu-logo-2 d-none g-max-width-180" src="/bitrix/images/landing/logos/valentine-logo-black.png" alt="" data-header-fix-moment-exclude="d-none" data-header-fix-moment-classes="d-block" data-filehash="bb21fd9632f1997bd4a83c6a9f06f301" />
							</a>
						</li>
						<!-- End Logo -->
						...
						<li class="landing-block-node-menu-list-item nav-item g-mx-30--lg g-mb-7 g-mb-0--lg">
							<a href="#block@block[04.7.one_col_fix_with_title_and_text_2]" class="landing-block-node-menu-list-item-link nav-link g-color-white p-0" target="_self">Testimonials</a>
						</li>
						<li class="landing-block-node-menu-list-item nav-item g-mx-30--lg g-mb-7 g-mb-0--lg">
							<a href="#block@block[43.2.three_tiles_with_img_zoom]" class="landing-block-node-menu-list-item-link nav-link g-color-white p-0" target="_self">offers</a>
						</li>
						<li class="landing-block-node-menu-list-item nav-item g-ml-30--lg">
							<a href="#block@block[04.1.one_col_fix_with_title@2]" class="landing-block-node-menu-list-item-link nav-link g-color-white p-0">Contact</a>
						</li>
					</ul>
				</div>
				<!-- End Navigation -->
	...
	<div class="container-fluid">
				...
				<div class="landing-block-node-inner-container g-flex-centered g-height-100vh--md g-min-height-300 g-py-40 g-pr-50--md text-md-right">
					<div class="w-100 u-bg-overlay__inner g-py-100 js-animation landing-block-node-inner-container-left landing-block-node-inner-container-right fadeInLeft">
						...
						<div class="landing-block-node-title-container g-brd-left g-brd-left-none--md g-brd-right--md g-brd-7 g-brd-primary g-color-white g-pl-30 g-pr-30 g-pl-0--lg g-mb-30">
							<h2 class="landing-block-node-title landing-block-node-title-left g-line-height-0_9 g-font-weight-700 g-font-size-76 mb-0 g-font-cormorant-infant g-text-transform-none"><span style="font-style: italic;">Gifts for her</span></h2>
						</div>
						<div class="landing-block-node-button-container">
							<a class="btn btn-lg u-btn-inset mx-2 landing-block-node-button g-rounded-50 u-btn-primary g-brd-0" href="#">Read more</a>
						</div>
					</div>
				</div>
			</div>
				...
				<div class="landing-block-node-inner-container g-flex-centered g-height-100vh--md g-min-height-300 g-py-40 g-pl-50--md">
					<div class="w-100 u-bg-overlay__inner g-py-100 js-animation landing-block-node-inner-container-right fadeInRight">
						...
						<div class="landing-block-node-title-container g-brd-left g-brd-7 g-brd-primary g-color-white g-pl-30 g-mb-30">
							<h2 class="landing-block-node-title landing-block-node-title-left g-line-height-0_9 g-font-weight-700 g-font-size-76 mb-0 g-font-cormorant-infant g-text-transform-none"><span style="font-style: italic;">Gifts for him</span></h2>
						</div>
						<div class="landing-block-node-button-container">
							<a class="btn btn-lg u-btn-inset mx-2 landing-block-node-button g-rounded-50 u-btn-primary g-brd-0" href="#">Read more</a>
						</div>
        ...
        <div class="container">
            <div class="landing-block-node-inner text-uppercase text-center u-heading-v2-4--bottom g-brd-primary">
                ...
                <h2 class="landing-block-node-title h1 u-heading-v2__title g-line-height-1_3 g-font-weight-600 g-mb-minus-10 g-font-cormorant-infant g-text-transform-none g-font-size-60"><span style="font-style: italic;">What we do</span></h2>
            </div>
        </div>
    </section>',
			),
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-5 g-mb-30 g-mb-0--md">
                    ...
                    <h3 class="landing-block-node-title g-font-weight-700 g-mb-20 g-font-cormorant-infant g-text-transform-none g-theme-event-color-gray-dark-v1 g-font-size-33"><span style="font-style: italic;">Working since 2011</span></h3>
                ...
                <div class="col-md-7">
                    <div aria-multiselectable="true">
                        <div class="landing-block-card-accordeon-element card g-brd-none js-animation fadeInUp">
                            <div class="card-header u-accordion__header g-bg-transparent g-brd-none rounded-0 p-0">
								<div class="landing-block-card-accordeon-element-title-link d-block text-uppercase g-pos-rel g-font-weight-700 g-font-size-12 g-brd-bottom g-brd-primary g-brd-2 g-py-15">
                                    <i class="landing-block-node-accordeon-element-img g-valign-middle g-font-size-23 g-mr-10 icon-diamond g-color-primary"></i>
                                    <div class="d-inline-block landing-block-node-accordeon-element-title g-font-cormorant-infant g-font-size-18 text-uppercase"><span style="font-style: italic;">Who we are</span></div>
                                </div>
                            </div>

                            <div class="landing-block-card-accordeon-element-body">
                                <div class="card-block u-accordion__body g-py-20 px-0">
                                    <div class="landing-block-node-accordeon-element-text g-font-size-default g-color-gray-dark-v5"><p>Anim pariatur cliche reprehenderit, 3 wolf moon officia aute, non cupidatat skateboard dolor brunch. Food truck quinoa nesciunt laborum eiusmod. </p></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="landing-block-card-accordeon-element card g-brd-none js-animation fadeInUp">
                            <div class="card-header u-accordion__header g-bg-transparent g-brd-none rounded-0 p-0">
                                <div class="landing-block-card-accordeon-element-title-link d-block text-uppercase g-pos-rel g-font-weight-700 g-font-size-12 g-brd-bottom g-brd-primary g-brd-2 g-py-15">
                                    <i class="landing-block-node-accordeon-element-img g-valign-middle g-font-size-23 g-mr-10 g-color-primary icon-present"></i>
                                    <div class="d-inline-block landing-block-node-accordeon-element-title g-font-cormorant-infant g-font-size-18 text-uppercase"><span style="font-style: italic;">Our history</span></div>
                                </div>
                            </div>

                            <div class="landing-block-card-accordeon-element-body">
                                <div class="card-block u-accordion__body g-py-20 px-0">
                                    <div class="landing-block-node-accordeon-element-text g-font-size-default g-color-gray-dark-v5"><p>Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus terry richardson ad squid. Food truck quinoa nesciunt laborum eiusmod. </p></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="landing-block-card-accordeon-element card g-brd-none js-animation fadeInUp">
                            <div class="card-header u-accordion__header g-bg-transparent g-brd-none rounded-0 p-0">
                                <div class="landing-block-card-accordeon-element-title-link d-block text-uppercase g-pos-rel g-font-weight-700 g-font-size-12 g-brd-bottom g-brd-primary g-brd-2 g-py-15">
                                    <i class="landing-block-node-accordeon-element-img g-valign-middle g-font-size-23 g-mr-10 g-color-primary icon-heart"></i>
                                    <div class="d-inline-block landing-block-node-accordeon-element-title g-font-cormorant-infant g-font-size-18 text-uppercase"><span style="font-style: italic;">Our services</span></div>
                                </div>
                            </div>

                            <div class="landing-block-card-accordeon-element-body">
                                <div class="card-block u-accordion__body g-py-20 px-0">
                                    <div class="landing-block-node-accordeon-element-text g-font-size-default g-color-gray-dark-v5"><p>3 wolf moon officia aute, non cupidatat skateboard dolor brunch. Food truck quinoa nesciunt laborum eiusmod. </p></div>
                                </div>
                            </div>
                        </div>
       ...
       <div class="row no-gutters g-overflow-hidden">
			...
			<div class="landing-block-card col-lg-6 landing-block-node-img g-min-height-500 g-bg-black-opacity-0_6--after g-bg-img-hero row no-gutters align-items-center
				...
				<div class="text-center u-bg-overlay__inner g-pa-40">
					...
					<div class="landing-block-node-button-container">
						<a class="landing-block-node-button btn btn-lg u-btn-inset mx-2 u-btn-primary g-rounded-50 g-brd-0 js-animation fadeIn" href="#" target="_self">READ MORE</a>
					</div>
				</div>
            </div>
	...
	<div class="container text-center text-lg-left g-color-white">
		<div class="row g-flex-centered">
			...
			<div class="col-lg-6 u-bg-overlay__inner g-flex-centered">
				<div class="w-100">
					<h2 class="landing-block-node-title g-line-height-1_1 g-font-weight-700 g-mb-10 g-font-cormorant-infant g-text-transform-none g-font-size-38 js-animation fadeInDown"><span style="font-style: italic;">
			...
			<a class="landing-block-node-button btn btn-lg u-btn-inset mx-2 g-flex-centered g-flex-right--lg u-btn-white g-color-primary g-brd-0 g-rounded-50 js-animation fadeInUp" href="#" target="_self">Get a quote</a>
		</div>
	</div>
</section>',
			),
        ...
        <div class="container text-center g-max-width-800 g-mb-20">
            ...
            <div class="landing-block-node-inner text-uppercase u-heading-v2-4--bottom g-brd-primary">
                ...
                <h2 class="landing-block-node-title u-heading-v2__title g-line-height-1_1 g-font-weight-700 g-color-black g-mb-minus-10 g-font-cormorant-infant g-text-transform-none g-font-size-60"><span style="font-style: italic;">What our clients say</span></h2>
            </div>

			<div class="landing-block-node-text g-color-gray-dark-v5 g-font-size-15">
        ...
        <div id="carouselFBK001" class="js-carousel" data-autoplay="true" data-infinite="true" data-slides-show="4">
            <div class="landing-block-card-carousel-element js-slide g-pt-60 g-pb-5 g-px-15">
                <div class="text-center u-shadow-v10 g-bg-white g-pa-0-35-35--sm g-pa-0-20-20">
                    ...
                    <h4 class="landing-block-node-title text-uppercase g-font-weight-700 g-font-size-default mb-0">Simone</h4>
                    <div class="landing-block-node-subtitle text-uppercase g-font-style-normal g-font-weight-700 g-font-size-10 g-color-gray-dark-v5">Bought flower set</div>
            ...
            <div class="landing-block-card-carousel-element js-slide g-pt-60 g-pb-5 g-px-15">
                <div class="text-center u-shadow-v10 g-bg-white g-pa-0-35-35--sm g-pa-0-20-20">
                    ...
                    <h4 class="landing-block-node-title text-uppercase g-font-weight-700 g-font-size-default mb-0">Carla</h4>
                    <div class="landing-block-node-subtitle text-uppercase g-font-style-normal g-font-weight-700 g-font-size-10 g-color-gray-dark-v5">Bought candies set</div>
                    <blockquote class="landing-block-node-text u-blockquote-v7 g-line-height-1_5 g-color-gray-dark-v5 g-bg-primary--before mb-0">Mauris sodales tellus vel felis dapibus, sit amet porta nibh egestas. Sed dignissim tellus quis sapien sagittis cursus. At
                        vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis.
                    </blockquote>
                </div>
            ...
            <div class="landing-block-card-carousel-element js-slide g-pt-60 g-pb-5 g-px-15">
                <div class="text-center u-shadow-v10 g-bg-white g-pa-0-35-35--sm g-pa-0-20-20">
                    ...
                    <h4 class="landing-block-node-title text-uppercase g-font-weight-700 g-font-size-default mb-0">Dianna</h4>
                    <div class="landing-block-node-subtitle text-uppercase g-font-style-normal g-font-weight-700 g-font-size-10 g-color-gray-dark-v5">Bought travel certificate</div>
                    <blockquote class="landing-block-node-text u-blockquote-v7 g-line-height-1_5 g-color-gray-dark-v5 g-bg-primary--before mb-0">Mauris sodales tellus vel felis dapibus, sit amet porta nibh egestas. Sed dignissim tellus quis sapien sagittis cursus. At
                        vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis.
                    </blockquote>
                </div>
            ...
            <div class="landing-block-card-carousel-element js-slide g-pt-60 g-pb-5 g-px-15">
                <div class="text-center u-shadow-v10 g-bg-white g-pa-0-35-35--sm g-pa-0-20-20">
                    ...
                    <h4 class="landing-block-node-title text-uppercase g-font-weight-700 g-font-size-default mb-0">John</h4>
                    <div class="landing-block-node-subtitle text-uppercase g-font-style-normal g-font-weight-700 g-font-size-10 g-color-gray-dark-v5">Bought flower set</div>
                    <blockquote class="landing-block-node-text u-blockquote-v7 g-line-height-1_5 g-color-gray-dark-v5 g-bg-primary--before mb-0">Mauris sodales tellus vel felis dapibus, sit amet porta nibh egestas. Sed dignissim tellus quis sapien sagittis cursus. At
                        vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis.
                    </blockquote>
            ...
            <div class="landing-block-card-carousel-element js-slide g-pt-60 g-pb-5 g-px-15">
                <div class="text-center u-shadow-v10 g-bg-white g-pa-0-35-35--sm g-pa-0-20-20">
                    ...
                    <h4 class="landing-block-node-title text-uppercase g-font-weight-700 g-font-size-default mb-0">SaraH</h4>
                    <div class="landing-block-node-subtitle text-uppercase g-font-style-normal g-font-weight-700 g-font-size-10 g-color-gray-dark-v5">Bought candies set</div>
                    <blockquote class="landing-block-node-text u-blockquote-v7 g-line-height-1_5 g-color-gray-dark-v5 g-bg-primary--before mb-0">Mauris sodales tellus vel felis dapibus, sit amet porta nibh egestas. Sed dignissim tellus quis sapien sagittis cursus. At
                        vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis.
                    </blockquote>
            ...
            <div class="landing-block-card-carousel-element js-slide g-pt-60 g-pb-5 g-px-15">
                <div class="text-center u-shadow-v10 g-bg-white g-pa-0-35-35--sm g-pa-0-20-20">
                    ...
                    <h4 class="landing-block-node-title text-uppercase g-font-weight-700 g-font-size-default mb-0">Derek</h4>
                    <div class="landing-block-node-subtitle text-uppercase g-font-style-normal g-font-weight-700 g-font-size-10 g-color-gray-dark-v5">Bought flower set</div>
                    <blockquote class="landing-block-node-text u-blockquote-v7 g-line-height-1_5 g-color-gray-dark-v5 g-bg-primary--before mb-0">Mauris sodales tellus vel felis dapibus, sit amet porta nibh egestas. Sed dignissim tellus quis sapien sagittis cursus. At
                        vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis.
                    </blockquote>
            ...
            <div class="landing-block-card-carousel-element js-slide g-pt-60 g-pb-5 g-px-15">
                <div class="text-center u-shadow-v10 g-bg-white g-pa-0-35-35--sm g-pa-0-20-20">
                    ...
                    <h4 class="landing-block-node-title text-uppercase g-font-weight-700 g-font-size-default mb-0">William</h4>
                    <div class="landing-block-node-subtitle text-uppercase g-font-style-normal g-font-weight-700 g-font-size-10 g-color-gray-dark-v5">Bought travel certificate</div>
                    <blockquote class="landing-block-node-text u-blockquote-v7 g-line-height-1_5 g-color-gray-dark-v5 g-bg-primary--before mb-0">Mauris sodales tellus vel felis dapibus, sit amet porta nibh egestas. Sed dignissim tellus quis sapien sagittis cursus. At
                        vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis.
                    </blockquote>
	...
	<div class="container">
		<div class="row">
			<div class="col-md-6 col-lg-4 g-mb-30 g-mb-0--lg">
				...
				<article class="text-center u-block-hover u-bg-overlay g-color-white g-bg-img-hero g-bg-black-opacity-0_3--after landing-block-node-block js-animation fadeInUp">
					<!-- Article Image -->
					<img class="landing-block-node-img1 w-100 u-block-hover__main--zoom-v1" src="https://cdn.bitrix24.site/bitrix/images/landing/business/800x867/img4.jpg" alt="" data-fileid="-1" data-filehash="9eef207add73028ae50f74a9033c20cb" />
					<!-- End Article Image -->
					...
					<div class="u-block-hover__additional u-bg-overlay__inner g-pos-abs g-flex-middle g-brd-around g-brd-2 g-brd-white-opacity-0_3 g-pa-15 g-ma-20">
						<div class="text-uppercase g-flex-middle-item">
							<h3 class="landing-block-node-subtitle1 g-font-weight-700 g-font-size-18 g-color-white g-brd-bottom g-brd-2 g-brd-primary g-mb-20">travel certificates</h3>
			...
			<div class="col-md-6 col-lg-4 g-mb-30 g-mb-0--lg">
				...
				<article class="text-center u-block-hover u-bg-overlay g-color-white g-bg-img-hero g-bg-black-opacity-0_3--after landing-block-node-block js-animation fadeInUp">
					<!-- Article Image -->
					<img class="landing-block-node-img2 w-100 u-block-hover__main--zoom-v1" src="https://cdn.bitrix24.site/bitrix/images/landing/business/800x867/img3.jpg" alt="" data-fileid="-1" data-filehash="9eef207add73028ae50f74a9033c20cb" />
					<!-- End Article Image -->
					...
					<div class="u-block-hover__additional u-bg-overlay__inner g-pos-abs g-flex-middle g-brd-around g-brd-2 g-brd-white-opacity-0_3 g-pa-15 g-ma-20">
						<div class="text-uppercase g-flex-middle-item">
							<h3 class="landing-block-node-subtitle2 g-font-weight-700 g-font-size-16 g-color-white g-mb-5">
								20% Discount</h3>
							<div class="landing-block-node-title2 text-uppercase g-line-height-1 g-font-weight-700 g-font-size-28 g-mb-10"><span style="font-weight: bold;">on candy sets</span></div>
			...
			<div class="col-lg-4">
				...
				<article class="landing-block-node-bg-mini text-center u-block-hover g-color-white g-bg-primary g-mb-30">
					<div class="g-brd-around g-brd-2 g-brd-white-opacity-0_3 g-pa-30 g-ma-20">
						<div class="g-flex-middle-item">
							<h3 class="landing-block-node-title-mini text-uppercase g-font-weight-700 g-font-size-18 g-color-white g-mb-10">romantic dinner</h3>
				...
				<article class="text-center u-block-hover u-bg-overlay g-color-white g-bg-img-hero g-bg-black-opacity-0_3--after landing-block-node-block js-animation fadeInUp">
					<!-- Article Image -->
					<img class="landing-block-node-img-mini w-100 u-block-hover__main--zoom-v1" src="https://cdn.bitrix24.site/bitrix/images/landing/business/800x401/img2.jpg" alt="" data-fileid="-1" data-filehash="9eef207add73028ae50f74a9033c20cb" />
					<!-- End Article Image -->
        ...
        <div class="container text-center g-max-width-800 g-mb-20">
            ...
            <div class="landing-block-node-inner text-uppercase u-heading-v2-4--bottom g-brd-primary">
                ...
                <h2 class="landing-block-node-title u-heading-v2__title g-line-height-1_1 g-font-weight-700 g-color-black g-mb-minus-10 g-font-cormorant-infant g-text-transform-none g-font-size-60"><span style="font-style: italic;">Our partners<br /></span></h2>
            </div>

			<div class="landing-block-node-text g-color-gray-dark-v5"><p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam.</p></div>
        </div>
	...
	<div class="container u-bg-overlay__inner text-center">
        ...
        <div class="container">
            <div class="landing-block-node-inner text-uppercase text-center u-heading-v2-4--bottom g-brd-primary">
                ...
                <h2 class="landing-block-node-title h1 u-heading-v2__title g-line-height-1_3 g-font-weight-600 g-mb-minus-10 g-font-cormorant-infant g-text-transform-none g-font-size-60"><span style="color: rgb(33, 33, 33); font-style: italic;">Get in touch</span></h2>
            </div>
        </div>
    </section>',
			),
		...
		<div class="row">
			<div class="col-md-6">
				<div class="text-center g-overflow-hidden">
					<h3 class="landing-block-node-main-title h3 text-uppercase g-font-weight-700 g-mb-20 g-color-black">Contact Us</h3>
					
					<div class="landing-block-node-text g-line-height-1_5 text-left g-mb-40 g-color-gray-dark-v5" data-form-style-main-font-family="1" data-form-style-main-font-weight="1" data-form-style-header-text-font-size="1"><p>Sed feugiat porttitor nunc, non dignissim ipsum vestibulum in. Donec in blandit dolor. Vivamus a fringilla lorem, vel faucibus ante. Nunc ullamcorper, justo a iaculis elementum, enim orci viverra eros, fringilla porttitor lorem eros vel odio.</p></div>
		...
		<div class="container text-center text-md-left u-bg-overlay__inner">
			<div class="row">
				<div class="col-md-4 col-lg-5 d-flex align-items-center g-mb-20 g-mb-0--md">
					<p class="w-100 g-font-size-13 g-color-white mb-0 landing-block-node-copy">&copy; 2018 All rights reserved</p>
				</div>
