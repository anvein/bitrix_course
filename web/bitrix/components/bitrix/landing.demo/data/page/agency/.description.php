...
return array(
	...
	'fields' => array(
		'ADDITIONAL_FIELDS' => array(
			...
			'METAOG_IMAGE' => 'https://repo.bitrix24.site/bitrix/images/demo/page/agency/preview.jpg',
...
<header class="landing-block landing-block-menu u-header u-header--static u-header--show-hide u-header--change-appearance" data-header-fix-moment="100" data-header-fix-effect="slide">
			...
			<div class="container">
				...
				<a href="#" class="landing-block-node-menu-logo-link navbar-brand u-header__logo p-0">
					<img class="landing-block-node-menu-logo u-header__logo-img u-header__logo-img--main g-max-width-180"
						 src="/bitrix/images/landing/logos/agency-logo-dark.png" alt="">
				</a>
				<!-- End Logo -->
				...
				<div class="collapse navbar-collapse align-items-center flex-sm-row" id="navBar">
					<ul class="landing-block-node-menu-list js-scroll-nav navbar-nav text-uppercase g-font-weight-700 g-font-size-11 ml-auto g-pt-20 g-pt-0--lg">
						...
						<li class="landing-block-node-menu-list-item nav-item g-ml-15--lg">
							<a href="#block@block[27.one_col_fix_title_and_text_2]" class="landing-block-node-menu-list-item-link nav-link p-0" target="_self">CONTACT</a>
						</li>
					</ul>
				</div>
				<!-- End Navigation -->
	...
	<div class="js-carousel"
		...
		<div class="landing-block-node-card landing-block-node-card-bgimg js-slide d-flex align-items-end u-bg-overlay g-height-100vh g-min-height-600 g-bg-img-hero g-bg-black-opacity-0_5--after"
		...
		<div class="row">
			<div class="landing-block-node-card js-animation fadeInUp col-md-6 col-lg-3 text-center g-mb-40 g-mb-0--lg animated landing-card">
					<span class="u-icon-v1 u-icon-size--lg g-color-white-opacity-0_6 g-mb-15">
						<i class="landing-block-node-card-icon g-color-primary icon-magic-wand"></i>
					</span>
			...
			<div class="landing-block-node-card js-animation fadeInUp col-md-6 col-lg-3 text-center g-mb-40 g-mb-0--lg animated landing-card">
					<span class="u-icon-v1 u-icon-size--lg g-color-white-opacity-0_6 g-mb-15">
						<i class="landing-block-node-card-icon g-color-primary icon-diamond"></i>
					</span>
			...
			<div class="landing-block-node-card js-animation fadeInUp col-md-6 col-lg-3 text-center g-mb-40 g-mb-0--lg animated landing-card">
					<span class="u-icon-v1 u-icon-size--lg g-color-white-opacity-0_6 g-mb-15">
						<i class="landing-block-node-card-icon g-color-primary icon-calculator"></i>
					</span>
			...
			<div class="landing-block-node-card js-animation fadeInUp col-md-6 col-lg-3 text-center g-mb-40 g-mb-0--lg animated landing-card">
					<span class="u-icon-v1 u-icon-size--lg g-color-white-opacity-0_6 g-mb-15">
						<i class="landing-block-node-card-icon g-color-primary icon-badge"></i>
					</span>
	...
	<div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="landing-block-card g-mb-40 g-mb-0--lg landing-card col-lg-3 js-animation fadeIn">
            ...
            <div class="container">
                <div class="row">
                    <div class="landing-block-card js-animation landing-block-node-contact g-brd-between-cols col-sm-3 g-brd-top g-brd-top-none--md g-brd-left--md g-brd-primary g-px-15 g-py-30 g-py-0--md fadeIn">
						...
						<h3 class="landing-block-node-contact-title text-uppercase g-font-size-default g-mb-5 g-color-white">Address</h3>
                        <div class="landing-block-node-contact-text g-font-size-default g-color-gray-dark-v5">
                    ...
                    <div class="landing-block-card js-animation landing-block-node-contact g-brd-between-cols col-sm-3 g-brd-top g-brd-top-none--md g-brd-left--md g-brd-primary g-px-15 g-py-30 g-py-0--md fadeIn">
                        ...
                        <h3 class="landing-block-node-contact-title text-uppercase g-font-size-default g-mb-5 g-color-white">Phone number</h3>
                         <div class="g-font-size-default g-color-gray-dark-v5">
                    ...
                    <div class="landing-block-card js-animation landing-block-node-contact g-brd-between-cols col-sm-3 g-brd-top g-brd-top-none--md g-brd-left--md g-brd-primary g-px-15 g-py-30 g-py-0--md fadeIn">
                        ...
                        <h3 class="landing-block-node-contact-title text-uppercase g-font-size-default g-mb-5 g-color-white">Email</h3>
                        <div class="g-font-size-default g-color-gray-dark-v5">
                    ...
                    <div class="landing-block-card js-animation landing-block-node-contact g-brd-between-cols col-sm-3 g-brd-top g-brd-top-none--md g-brd-left--md g-brd-primary g-px-15 g-py-30 g-py-0--md fadeIn">
                        ...
                        <h3 class="landing-block-node-contact-title text-uppercase g-font-size-default g-mb-5 g-color-white">Toll free</h3>
                        <div class="landing-block-node-contact-text g-font-size-default g-color-gray-dark-v5">
