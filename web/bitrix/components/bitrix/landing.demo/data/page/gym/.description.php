...
return array(
	...
	'fields' => array(
		'ADDITIONAL_FIELDS' => array(
			'THEME_CODE' => 'gym',
			'THEME_CODE_TYPO' => 'gym',
			'METAOG_IMAGE' => 'https://repo.bitrix24.site/bitrix/images/demo/page/gym/preview.jpg',
			...
			<div class="container">
				...
				<a href="#" class="landing-block-node-menu-logo-link navbar-brand u-header__logo">
					<img class="landing-block-node-menu-logo u-header__logo-img u-header__logo-img--main g-max-width-180"
						 src="/bitrix/images/landing/logos/gym-logo.png"
						 alt="">
				</a>
				<!-- End Logo -->
				...
				<div class="collapse navbar-collapse align-items-center flex-sm-row" id="navBar">
					<ul class="landing-block-node-menu-list js-scroll-nav navbar-nav text-uppercase g-letter-spacing-2 g-font-size-11 g-pt-20 g-pt-0--lg ml-auto">
						<li class="landing-block-node-menu-list-item nav-item g-mr-15--lg g-mb-7 g-mb-0--lg active">
							<a href="#block@block[0.menu_12_gym]" class="landing-block-node-menu-list-item-link nav-link p-0 g-color-white" target="_self">HOME</a><span class="sr-only">(current)</span>
						</li>
						<li class="landing-block-node-menu-list-item nav-item g-mx-15--lg g-mb-7 g-mb-0--lg">
							<a href="#block@block[46.8.cover_bgimg_title_with_icons]" class="landing-block-node-menu-list-item-link nav-link p-0 g-color-white" target="_self">ABOUT</a>
						</li>
						<li class="landing-block-node-menu-list-item nav-item g-mx-15--lg g-mb-7 g-mb-0--lg">
							<a href="#block@block[04.1.one_col_fix_with_title]" class="landing-block-node-menu-list-item-link nav-link p-0 g-color-white" target="_self">SERVICES</a>
						</li>
						<li class="landing-block-node-menu-list-item nav-item g-mx-15--lg g-mb-7 g-mb-0--lg">
							<a href="#block@block[21.1.four_cols_big_bgimg_title_text_button]" class="landing-block-node-menu-list-item-link nav-link p-0 g-color-white" target="_self">STUDIOS</a>
						</li>
						
						<li class="landing-block-node-menu-list-item nav-item g-mx-15--lg g-mb-7 g-mb-0--lg">
							<a href="#block@block[27.one_col_fix_title_and_text_2]" class="landing-block-node-menu-list-item-link nav-link p-0 g-color-white" target="_self">LESSONS</a>
						</li>
						<li class="landing-block-node-menu-list-item nav-item g-mx-15--lg g-mb-7 g-mb-0--lg">
							<a href="#block@block[27.one_col_fix_title_and_text_2@2]" class="landing-block-node-menu-list-item-link nav-link p-0 g-color-white" target="_self">TEAM</a>
						</li>
						<li class="landing-block-node-menu-list-item nav-item g-ml-15--lg">
							<a href="#block@block[27.one_col_fix_title_and_text_2@3]" class="landing-block-node-menu-list-item-link nav-link p-0 g-color-white" target="_self">CONTACT</a>
						</li>
					</ul>
				</div>
				<!-- End Navigation -->
	...
	<div class="u-bg-overlay__inner g-absolute-centered w-100">
        ...
        <div class="row no-gutters g-overflow-hidden">
				<div class="landing-block-card col-lg-6 landing-block-node-img g-min-height-500 g-bg-img-hero row no-gutters align-items-center justify-content-center u-bg-overlay g-transition--ease-in g-transition-0_2 g-transform-scale-1_03--hover landing-card g-bg-black-opacity-0_2--after" style="background-image: url(\'https://cdn.bitrix24.site/bitrix/images/landing/business/800x534/img1.jpg\');" data-fileid="-1">
					<div class="text-center u-bg-overlay__inner g-pa-40">
						...
						<div class="landing-block-node-text g-color-white-opacity-0_7 js-animation fadeIn animated"><p>PILATES</p><p>YOGA</p><p>CROSSFIT</p><p>WOMEN BOXING</p><p>CYCLING</p><p>FITNESS</p></div>
						<div class="landing-block-node-button-container">
				...
				<div class="landing-block-card col-lg-6 landing-block-node-img g-min-height-500 g-bg-img-hero row no-gutters align-items-center justify-content-center u-bg-overlay g-transition--ease-in g-transition-0_2 g-transform-scale-1_03--hover landing-card g-bg-black-opacity-0_2--after" style="background-image: url(\'https://cdn.bitrix24.site/bitrix/images/landing/business/800x534/img2.jpg\');" data-fileid="-1">
					<div class="text-center u-bg-overlay__inner g-pa-40">
						<h3 class="landing-block-node-title text-uppercase g-font-weight-700 g-font-size-18 g-color-white g-mb-20 js-animation fadeIn animated">FOR ALL</h3>
						<div class="landing-block-node-text g-color-white-opacity-0_7 js-animation fadeIn animated"><p>ZUMBA</p><p>TRX</p><p>STEP</p><p>CARDIO</p><p>STRECHING</p><p>ZUMBA</p></div>
						<div class="landing-block-node-button-container">
							<a class="landing-block-node-button btn btn-lg u-btn-inset mx-2 js-animation fadeIn animated g-rounded-50 u-btn-primary" href="#">
								Read more
							</a>
        ...
        <div class="row no-gutters g-overflow-hidden">
                ...
                <div class="landing-block-card col-lg-2 landing-block-node-img g-min-height-350 g-bg-img-hero row no-gutters align-items-center justify-content-center u-bg-overlay g-transition--ease-in g-transition-0_2 g-transform-scale-1_03--hover landing-card g-bg-black-opacity-0_2--after" style="background-image: url(https://cdn.bitrix24.site/bitrix/images/landing/business/280x500/img2.jpg);">
					<div class="text-center u-bg-overlay__inner g-pa-40">
                        <h3 class="landing-block-node-title text-uppercase g-font-weight-700 g-color-white g-mb-20 g-letter-spacing-2 js-animation fadeIn animated g-font-size-16">BOX FOR WOMEN</h3>
                        <div class="landing-block-node-text g-color-white-opacity-0_7 js-animation fadeIn animated"><p>Sed feugiat porttitor nunc, non dignis sim ipsum vestibulum in.</p></div>
                        <div class="landing-block-node-button-container">
                        	<a class="landing-block-node-button btn btn-lg u-btn-inset mx-2 js-animation fadeIn animated g-rounded-50 u-btn-primary" href="#" target="_self">Read more</a>
                        </div>
            	...
            	<div class="landing-block-card col-lg-2 landing-block-node-img g-min-height-350 g-bg-img-hero row no-gutters align-items-center justify-content-center u-bg-overlay g-transition--ease-in g-transition-0_2 g-transform-scale-1_03--hover landing-card g-bg-black-opacity-0_2--after" style="background-image: url(https://cdn.bitrix24.site/bitrix/images/landing/business/280x500/img4.jpg);">
					<div class="text-center u-bg-overlay__inner g-pa-40">
                        <h3 class="landing-block-node-title text-uppercase g-font-weight-700 g-color-white g-mb-20 g-letter-spacing-2 js-animation fadeIn animated g-font-size-16">BOX FOR MEN</h3>
                        <div class="landing-block-node-text g-color-white-opacity-0_7 js-animation fadeIn animated"><p>Sed feugiat porttitor nunc, non dignis sim ipsum vestibulum in.</p></div>
                        <div class="landing-block-node-button-container">
                        	<a class="landing-block-node-button btn btn-lg u-btn-inset mx-2 js-animation fadeIn animated g-rounded-50 u-btn-primary" href="#" target="_self">Read more</a>
                        </div>
	...
	<div>
        ...
        <div class="container g-max-width-800 g-py-20">
            <div class="text-center g-mb-20">
                <h2 class="landing-block-node-title g-font-weight-400 text-uppercase g-letter-spacing-2 g-font-size-25"><span style="font-weight: bold;">MEET WITH OUR TEAM</span></h2>
		...
		<div class="row">
			...
			<div class="landing-block-card-employee js-animation col-md-6 col-lg-3 g-mb-30 g-mb-0--md fadeIn">
				<div class="text-center">
					...
					<!-- Figure Info -->
					<em class="landing-block-node-employee-post d-block g-font-style-normal g-font-weight-700 g-color-primary g-mb-5 g-text-transform-none g-font-size-14"><span style="font-weight: normal;">Cardio, Pilates, Zymba</span></em>
			...
			<div class="landing-block-card-employee js-animation col-md-6 col-lg-3 fadeIn">
				<div class="text-center">
					...
					<!-- Figure Info -->
					<em class="landing-block-node-employee-post d-block g-font-style-normal g-font-weight-700 g-color-primary g-mb-5 g-text-transform-none g-font-size-14"><span style="font-weight: normal;">Box, Kikcboxing, Gym, Crossfit</span></em>
