...
<div class="bx-catalog-element bx-<?=$arParams['TEMPLATE_THEME']?>" id="<?=$itemIds['ID']?>" itemscope itemtype="http://schema.org/Product">
										...
										<div class="mb-3" id="<?=$itemIds['TREE_ID']?>">
											...
											foreach ($arResult['SKU_PROPS'] as $skuProperty)
											{
												...
												<div data-entity="sku-line-block">
													...
													<div class="product-item-scu-container mb-3">
						...
						foreach ($arParams['PRODUCT_PAY_BLOCK_ORDER'] as $blockName)
						{
							switch ($blockName)
							{
									...
									<div class="mb-3">
										...
										if ($arParams['SHOW_OLD_PRICE'] === 'Y')
										{
											...
											<div class="product-item-detail-price-old"
												 ...
												 style="display: <?=($showDiscount ? '' : 'none')?>;"><?=($showDiscount ? $price['PRINT_RATIO_BASE_PRICE'] : '')?></div>
											<?
										}
										?>
								...
								case 'quantity':
									...
									{
										?>
										<div class="mb-3" style="<?=(!$actualItem['CAN_BUY'] ? 'display: none;' : '')?>"
								...
								case 'buttons':
									...
									<div class="mb-3">
										<a class="btn btn-link product-item-detail-buy-button"
										   ...
										   rel="nofollow"
										   style="display: <?=(!$actualItem['CAN_BUY'] ? '' : 'none')?>;"><span><?=$arParams['MESS_NOT_AVAILABLE']?></span></a>
									</div>
									<?
									break;
							}
	...
	<!--Top tabs-->
	<div class="p-2 pb-0 product-item-detail-tabs-container-fixed d-none d-md-block" id="<?=$itemIds['TABS_PANEL_ID']?>">
		<ul class="product-item-detail-tabs-list">
			<?
			if ($showDescription)
			{
