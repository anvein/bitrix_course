...
return array(
	...
	'fields' => array(
		'ADDITIONAL_FIELDS' => array(
			...
			'METAOG_IMAGE' => 'https://repo.bitrix24.site/bitrix/images/demo/page/courses/preview.jpg',
...
<header class="landing-block landing-block-menu g-bg-white u-header u-header--sticky-top u-header--change-appearance g-z-index-9999" data-header-fix-moment="100">
	<div class="u-header__section u-shadow-v27 g-transition-0_3 g-py-17" data-header-fix-moment-exclude="g-py-17" data-header-fix-moment-classes="g-py-12">
			...
			<div class="container">
				...
				<a href="#" class="landing-block-node-menu-logo-link navbar-brand u-header__logo p-0">
					<img class="landing-block-node-menu-logo u-header__logo-img u-header__logo-img--main g-max-width-180"
						 src="/bitrix/images/landing/logos/courses-logo-dark.png" alt="Logo">
				</a>
				<!-- End Logo -->
				...
				<div class="collapse navbar-collapse align-items-center flex-sm-row" id="navBar">
					<ul class="landing-block-node-menu-list js-scroll-nav navbar-nav text-uppercase g-font-weight-700 g-font-size-12 g-pt-20 g-pt-0--lg g-mb-20 g-mb-0--lg ml-auto g-mr-20">
						<li class="landing-block-node-menu-list-item nav-item g-mr-3--lg g-mb-5 g-mb-0--lg active">
							<a href="#block@block[40.1.three_cols_carousel]" class="landing-block-node-menu-list-item-link nav-link g-color-black nav-link-color-hover" target="_self">HOME</a><span class="sr-only">(current)</span>
						</li>
						<li class="landing-block-node-menu-list-item nav-item g-mx-3--lg g-mb-5 g-mb-0--lg">
							<a href="#block@block[31.1.two_cols_text_img]" class="landing-block-node-menu-list-item-link nav-link g-color-black nav-link-color-hover" target="_self">ABOUT</a>
						</li>
						<li class="landing-block-node-menu-list-item nav-item g-mx-3--lg g-mb-5 g-mb-0--lg">
							<a href="#block@block[04.1.one_col_fix_with_title]" class="landing-block-node-menu-list-item-link nav-link g-color-black nav-link-color-hover" target="_self">OUR COURSES</a>
						</li>
						<li class="landing-block-node-menu-list-item nav-item g-mx-3--lg g-mb-5 g-mb-0--lg">
							<a href="#block@block[04.7.one_col_fix_with_title_and_text_2]" class="landing-block-node-menu-list-item-link nav-link g-color-black nav-link-color-hover" target="_self">OUR NUMBERS</a>
						</li>
						<li class="landing-block-node-menu-list-item nav-item g-mx-3--lg g-mb-5 g-mb-0--lg">
							<a href="#block@block[04.1.one_col_fix_with_title@2]" class="landing-block-node-menu-list-item-link nav-link g-color-black nav-link-color-hover" target="_self">GALLERY</a>
						</li>
						<li class="landing-block-node-menu-list-item nav-item g-mx-3--lg g-mb-5 g-mb-0--lg">
							<a href="#block@block[04.7.one_col_fix_with_title_and_text_2@2]" class="landing-block-node-menu-list-item-link nav-link g-color-black nav-link-color-hover" target="_self">TEACHERS</a>
						</li>
						<li class="landing-block-node-menu-list-item nav-item g-mx-3--lg g-mb-5 g-mb-0--lg">
							<a href="#block@block[04.1.one_col_fix_with_title@3]" class="landing-block-node-menu-list-item-link nav-link g-color-black nav-link-color-hover" target="_self">OFFERS</a>
						</li>
						<li class="landing-block-node-menu-list-item nav-item g-mx-3--lg g-mb-5 g-mb-0--lg">
							<a href="#block@block[04.7.one_col_fix_with_title_and_text_2@3]" class="landing-block-node-menu-list-item-link nav-link g-color-black nav-link-color-hover" target="_self">PARTNERS</a>
						</li>
						<li class="landing-block-node-menu-list-item nav-item g-mx-3--lg g-mb-5 g-mb-0--lg">
							<a href="#block@block[40.2.two_cols_carousel]" class="landing-block-node-menu-list-item-link nav-link g-color-black nav-link-color-hover" target="_self">BLOG</a>
						</li>
						<li class="landing-block-node-menu-list-item nav-item g-ml-3--lg">
							<a href="#block@block[04.1.one_col_fix_with_title@4]" class="landing-block-node-menu-list-item-link nav-link g-color-black nav-link-color-hover" target="_self">CONTACT</a>
						</li>
					</ul>
...
<!--					</ul>-->
	...
	<div class="container-fluid g-px-30">
		<div id="carouselCourses1" class="js-carousel g-pos-rel g-mx-minus-15"
			 data-infinite="true"
			 data-autoplay="true"
			 data-slides-show="3">
	...
	<div>
		<div class="row mx-0">
			<div class="col-md-6 text-center text-md-left g-py-50 g-py-100--md g-px-15 g-px-50--md">
				<h3 class="landing-block-node-title text-uppercase g-font-weight-700 g-font-size-default g-mb-25 g-color-black g-font-size-27 js-animation fadeInUp animated">QUALITY RESULTS WITH US</h3>
				<div class="landing-block-node-text g-mb-30 g-color-gray-dark-v2 js-animation fadeInUp animated"><p>Etiam dolor tortor, egestas a libero eget, sollicitudin maximus nulla. Nunc vitae maximus ipsum. Vestibulum sodales nisi massa, vitae blandit massa luctus id.</p></div>
				<div class="landing-block-node-button-container">
					<a class="landing-block-node-button text-uppercase btn btn-xl u-btn-primary g-font-weight-700 g-font-size-12 js-animation fadeInUp animated rounded-0" href="#" tabindex="0" target="_self">VIEW OUR PROMO VIDEO</a>
				</div>
			</div>
        ...
        <div class="container">
            <div class="landing-block-node-inner text-uppercase text-center u-heading-v2-4--bottom g-brd-primary">
                <h4 class="landing-block-node-subtitle h6 g-font-weight-800 g-font-size-12 g-letter-spacing-1 g-mb-20 g-color-gray-dark-v5">OUR COURSES</h4>
	...
	<div class="container">
        ...
        <div class="container landing-block-node-subcontainer text-center g-max-width-800 g-mb-20">
            ...
            <div class="landing-block-node-inner text-uppercase u-heading-v2-4--bottom g-brd-primary">
                <h4 class="landing-block-node-subtitle g-font-weight-700 g-font-size-12 g-mb-15 g-color-gray-dark-v5">OUR NUMBERS</h4>
                <h2 class="landing-block-node-title u-heading-v2__title g-line-height-1_1 g-font-weight-700 g-color-black g-mb-minus-10 g-font-size-27">WE WORK HARD</h2>
            </div>

			<div class="landing-block-node-text g-color-gray-dark-v5"><p>Etiam dolor tortor, egestas a libero eget, sollicitudin maximus nulla. Nunc vitae maximus ipsum. Vestibulum sodales nisi massa, vitae blandit massa luctus id.</p></div>
        </div>
	...
	<div class="container">
        ...
        <div class="container">
            <div class="landing-block-node-inner text-uppercase text-center u-heading-v2-4--bottom g-brd-primary">
                <h4 class="landing-block-node-subtitle h6 g-font-weight-800 g-font-size-12 g-letter-spacing-1 g-mb-20 g-color-gray-dark-v5">GALLERY</h4>
...
<br />BLACKWATER</h4>
        ...
        <div class="container">
            <div class="landing-block-node-inner text-uppercase text-center u-heading-v2-4--bottom g-brd-primary">
                <h4 class="landing-block-node-subtitle h6 g-font-weight-800 g-font-size-12 g-letter-spacing-1 g-mb-20 g-color-gray-dark-v5">OUR OFFERS</h4>
        ...
        <div class="container landing-block-node-subcontainer text-center g-max-width-800 g-mb-20">
            ...
            <div class="landing-block-node-inner text-uppercase u-heading-v2-4--bottom g-brd-primary">
                <h4 class="landing-block-node-subtitle g-font-weight-700 g-font-size-12 g-mb-15 g-color-gray-dark-v5">OUR PARTNERS</h4>
                <h2 class="landing-block-node-title u-heading-v2__title g-line-height-1_1 g-font-weight-700 g-color-black g-mb-minus-10 g-font-size-27">WHO TRUSTS US</h2>
            </div>
	...
	<div class="container-fluid g-px-30">
		<div id="carouselCourses2" class="js-carousel g-pos-rel g-mx-minus-15" data-infinite="true" data-slides-show="2">
			<div class="landing-block-node-card js-slide g-px-15">
				<!-- Article -->
        ...
        <div class="container">
            <div class="landing-block-node-inner text-uppercase text-center u-heading-v2-4--bottom g-brd-primary">
                <h4 class="landing-block-node-subtitle h6 g-font-weight-800 g-font-size-12 g-letter-spacing-1 g-color-primary g-mb-20"> </h4>
                <h2 class="landing-block-node-title h1 u-heading-v2__title g-line-height-1_3 g-font-weight-600 g-mb-minus-10 g-font-size-27">WRITE US</h2>
            </div>
        </div>
    </section>',
			),
	...
	<div class="container">
		...
		'35.2.footer_dark' =>
			array (
				...
				'SORT' => '10000',
				'CONTENT' => '<section class="g-color-gray-light-v1 g-py-60 g-pt-55 g-pb-30 g-bg-pattern-green-v1">
	<div class="container">
		<div class="row">
			<div class="col-sm-12 col-md-6 col-lg-6 g-mb-25 g-mb-0--lg">
				...
				<div class="landing-block-node-text g-font-size-default g-mb-20 g-color-gray-light-v5"><p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin vitae est lorem. Aenean imperdiet nisi a dolor condimentum, id ullamcorper lacus vestibulum.</p></div>
				...
				<!--						<a class="u-icon-v2 g-width-35 g-height-35 g-font-size-default g-color-gray-light-v1 g-color-white--hover g-bg-primary--hover g-brd-gray-dark-v2 g-brd-primary--hover g-rounded-50x g-mx-5"-->
