...
<header class="landing-block landing-block-menu g-bg-white u-header u-header--floating g-z-index-9999">
	<div class="u-header__section g-transition-0_3 g-py-25" data-header-fix-moment-exclude="g-py-25" data-header-fix-moment-classes="u-shadow-v27 g-py-15">
				...
				<div class="collapse navbar-collapse align-items-center flex-sm-row" id="navBar">
					<ul class="landing-block-node-menu-list js-scroll-nav navbar-nav text-uppercase g-font-weight-700 g-font-size-12 g-pt-20 g-pt-0--lg ml-auto">
						<li class="landing-block-node-menu-list-item nav-item g-mr-10--lg g-mb-7 g-mb-0--lg active">
							<a href="#block@block[01.big_with_text_blocks]" class="landing-block-node-menu-list-item-link nav-link p-0 g-color-black g-font-open-sans" target="_self">Home</a><span
 class="sr-only">(current)
						</span
></li>
						<li class="landing-block-node-menu-list-item nav-item g-mx-10--lg g-mb-7 g-mb-0--lg">
							<a href="#block@block[01.big_with_text_blocks]" class="landing-block-node-menu-list-item-link nav-link p-0 g-color-black g-font-open-sans" target="_self">About</a>
						</li>
						<li class="landing-block-node-menu-list-item nav-item g-mx-10--lg g-mb-7 g-mb-0--lg">
							<a href="#block@block[47.1.title_with_icon]" class="landing-block-node-menu-list-item-link nav-link p-0 g-color-black g-font-open-sans" target="_self">Presentation</a>
						</li>
						<li class="landing-block-node-menu-list-item nav-item g-mx-10--lg g-mb-7 g-mb-0--lg">
							<a href="#block@block[47.1.title_with_icon@2]" class="landing-block-node-menu-list-item-link nav-link p-0 g-color-black g-font-open-sans" target="_self">Gallery</a>
						</li>
						<li class="landing-block-node-menu-list-item nav-item g-mx-10--lg g-mb-7 g-mb-0--lg">
							<a href="#block@block[27.one_col_fix_title_and_text_2]" class="landing-block-node-menu-list-item-link nav-link p-0 g-color-black g-font-open-sans" target="_self">Services</a>
						</li>
						<li class="landing-block-node-menu-list-item nav-item g-mx-10--lg g-mb-7 g-mb-0--lg">
							<a href="#block@block[46.3.cover_with_blocks_slider]" class="landing-block-node-menu-list-item-link nav-link p-0 g-color-black g-font-open-sans" target="_self">Testimonials</a>
						</li>
						<li class="landing-block-node-menu-list-item nav-item g-mx-10--lg g-mb-7 g-mb-0--lg">
							<a href="#block@block[47.1.title_with_icon@3]" class="landing-block-node-menu-list-item-link nav-link p-0 g-color-black g-font-open-sans" target="_self">Offers</a>
						</li>
						<li class="landing-block-node-menu-list-item nav-item g-mx-10--lg g-mb-7 g-mb-0--lg">
							<a href="#block@block[47.1.title_with_icon@4]" class="landing-block-node-menu-list-item-link nav-link p-0 g-color-black g-font-open-sans" target="_self">News</a>
						</li>
						<li class="landing-block-node-menu-list-item nav-item g-mx-10--lg g-mb-7 g-mb-0--lg">
							<a href="#block@block[47.1.title_with_icon@5]" class="landing-block-node-menu-list-item-link nav-link p-0 g-color-black g-font-open-sans" target="_self">Booking
								form</a>
						</li>
	...
	<div class="container">
		<div class="row">
			<div class="landing-block-node-card js-animation col-md-6 col-lg-6 g-pt-30 g-mb-50 g-mb-0--md fadeIn animated landing-card">
				<!-- Article -->
				<article class="text-center">
					<!-- Article Image -->
					<img class="landing-block-node-card-photo g-max-width-200 g-rounded-50x g-mb-20" src="https://cdn.bitrix24.site/bitrix/images/landing/business/300x300/img1.jpg" alt="" />
					<!-- End Article Image -->
			...
			<div class="landing-block-node-card js-animation col-md-6 col-lg-6 g-pt-30 g-mb-50 g-mb-0--md fadeIn animated landing-card">
				...
				<article class="text-center">
					<!-- Article Image -->
					<img class="landing-block-node-card-photo g-max-width-200 g-rounded-50x g-mb-20" src="https://cdn.bitrix24.site/bitrix/images/landing/business/300x300/img2.jpg" alt="" />
					<!-- End Article Image -->
	...
	<div class="container">
		<div class="row">
			<div class="landing-block-node-card col-md-6 col-lg-3 text-center g-mb-40 g-mb-0--lg js-animation fadeInUp animated landing-card">
	...
	<div class="container u-bg-overlay__inner">
		<div class="row">
			...
			<div class="landing-block-card d-flex flex-column col-md-3 g-mb-20 g-mb-0--md js-animation fadeIn animated landing-card">
				...
				<img class="landing-block-node-img img-fluid g-mb-20" src="https://cdn.bitrix24.site/bitrix/images/landing/business/315x435/img1.jpg" alt="" data-fileid="-1" data-filehash="9eef207add73028ae50f74a9033c20cb" />
			...
			<div class="landing-block-card d-flex flex-column col-md-3 g-mb-20 g-mb-0--md js-animation fadeIn animated landing-card">
				...
				<img class="landing-block-node-img img-fluid g-mb-20" src="https://cdn.bitrix24.site/bitrix/images/landing/business/315x435/img2.jpg" alt="" data-fileid="-1" data-filehash="9eef207add73028ae50f74a9033c20cb" />
				<div class="g-mb-40 landing-block-node-text g-line-height-1_8 g-font-size-default g-color-white-opacity-0_8 g-font-size-14 g-font-open-sans text-left"><p>Nunc vitae maximus. Vestibulum sodales nisi massa, vitae blandit massa luctus id. Nunc diam tellus.</p></div>
				<div class="landing-block-node-button-container mt-auto">
					<a class="landing-block-node-button btn btn-lg u-btn-inset u-btn-white g-font-open-sans g-color-primary g-font-size-11 g-rounded-25 g-brd-0" href="#" target="_self">View More</a>
				</div>
			...
			<div class="landing-block-card d-flex flex-column col-md-3 g-mb-20 g-mb-0--md js-animation fadeIn animated landing-card">
				...
				<img class="landing-block-node-img img-fluid g-mb-20" src="https://cdn.bitrix24.site/bitrix/images/landing/business/315x435/img3.jpg" alt="" data-fileid="-1" data-filehash="9eef207add73028ae50f74a9033c20cb" />
				<div class="g-mb-40 landing-block-node-text g-line-height-1_8 g-font-size-default g-color-white-opacity-0_8 g-font-size-14 g-font-open-sans text-left"><p>Nunc vitae maximus. Vestibulum sodales nisi massa, vitae blandit massa luctus id. Nunc diam tellus.</p></div>
				<div class="landing-block-node-button-container mt-auto">
					<a class="landing-block-node-button btn btn-lg u-btn-inset u-btn-white g-font-open-sans g-color-primary g-font-size-11 g-rounded-25 g-brd-0" href="#" target="_self">View More</a>
				</div>
			...
			<div class="landing-block-card d-flex flex-column col-md-3 g-mb-20 g-mb-0--md js-animation fadeIn animated landing-card">
				...
				<img class="landing-block-node-img img-fluid g-mb-20" src="https://cdn.bitrix24.site/bitrix/images/landing/business/315x435/img4.jpg" alt="" data-fileid="-1" data-filehash="9eef207add73028ae50f74a9033c20cb" />
				<div class="g-mb-40 landing-block-node-text g-line-height-1_8 g-font-size-default g-color-white-opacity-0_8 g-font-size-14 g-font-open-sans text-left"><p>Nunc vitae maximus. Vestibulum sodales nisi massa, vitae blandit massa luctus id. Nunc diam tellus.</p></div>
				<div class="landing-block-node-button-container mt-auto">
					<a class="landing-block-node-button btn btn-lg u-btn-inset u-btn-white g-font-open-sans g-color-primary g-font-size-11 g-rounded-25 g-brd-0" href="#" target="_self">View More</a>
				</div>
		...
		'46.3.cover_with_blocks_slider' =>
			array (
				...
				'SORT' => '5500',
				'CONTENT' => '<section class="landing-block landing-block-node-bgimg u-bg-overlay g-bg-img-hero g-bg-black-opacity-0_5--after g-py-100" style="background-image: url(https://cdn.bitrix24.site/bitrix/images/landing/business/1920x1280/img21.jpg);">
	<div class="container u-bg-overlay__inner">
	...
	<div class="container">
		<div class="row">
			<div class="landing-block-node-card col-md-6 col-lg-4 g-mb-30 landing-card">
				<!-- Article -->
