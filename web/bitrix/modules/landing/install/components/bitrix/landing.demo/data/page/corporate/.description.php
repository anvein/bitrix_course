...
return array(
	...
	'fields' => array(
		'ADDITIONAL_FIELDS' => array(
			...
			'METAOG_IMAGE' => 'https://repo.bitrix24.site/bitrix/images/demo/page/corporate/preview.jpg',
...
?>
<header class="landing-block landing-block-menu g-bg-white u-header u-header--sticky-top u-header--change-appearance" data-header-fix-moment="100">
	<div class="u-header__section g-transition-0_3 g-py-7 g-py-23--md" data-header-fix-moment-exclude="g-py-23--md" data-header-fix-moment-classes="g-py-17--md">
			...
			<div class="container">
				...
				<a href="#" class="landing-block-node-menu-logo-link navbar-brand u-header__logo">
					<img class="landing-block-node-menu-logo u-header__logo-img u-header__logo-img--main g-max-width-180"
						 src="/bitrix/images/landing/logos/corporate-logo.png" alt="">
				</a>
				<!-- End Logo -->
				...
				<div class="collapse navbar-collapse align-items-center flex-sm-row" id="navBar">
					<ul class="landing-block-node-menu-list js-scroll-nav navbar-nav text-uppercase g-letter-spacing-1 g-font-size-12 g-pt-20 g-pt-0--lg ml-auto">
						<li class="landing-block-node-menu-list-item nav-item g-mr-15--lg g-mb-7 g-mb-0--lg active">
							<a href="#block@block[46.7.cover_bgimg_text_blocks_with_icons]" class="landing-block-node-menu-list-item-link nav-link p-0 g-color-black" target="_self">HOME</a><span class="sr-only">(current)</span>
						</li>
						<li class="landing-block-node-menu-list-item nav-item g-mx-15--lg g-mb-7 g-mb-0--lg">
							<a href="#block@block[02.three_cols_big_1]" class="landing-block-node-menu-list-item-link nav-link p-0 g-color-black" target="_self">ABOUT</a>
						</li>
						<li class="landing-block-node-menu-list-item nav-item g-mx-15--lg g-mb-7 g-mb-0--lg">
							<a href="#block@block[27.one_col_fix_title_and_text_2]" class="landing-block-node-menu-list-item-link nav-link p-0 g-color-black" target="_self">PORTFOLIO</a>
						</li>
						<li class="landing-block-node-menu-list-item nav-item g-mx-15--lg g-mb-7 g-mb-0--lg">
							<a href="#block@block[11.three_cols_fix_tariffs]" class="landing-block-node-menu-list-item-link nav-link p-0 g-color-black" target="_self">PRICING</a>
						</li>
						<li class="landing-block-node-menu-list-item nav-item g-mx-15--lg g-mb-7 g-mb-0--lg">
							<a href="#block@block[27.one_col_fix_title_and_text_2@2]" class="landing-block-node-menu-list-item-link nav-link p-0 g-color-black" target="_self">TEAM</a>
						</li>
						<li class="landing-block-node-menu-list-item nav-item g-mx-15--lg g-mb-7 g-mb-0--lg">
							<a href="#block@block[27.one_col_fix_title_and_text_2@4]" class="landing-block-node-menu-list-item-link nav-link p-0 g-color-black" target="_self">BLOG</a>
						</li>
						<li class="landing-block-node-menu-list-item nav-item g-mx-15--lg g-mb-7 g-mb-0--lg">
							<a href="#block@block[01.big_with_text_2]" class="landing-block-node-menu-list-item-link nav-link p-0 g-color-black" target="_self">CONTACT</a>
						</li>
...
',
	...
	<div>
		<div class="row mx-0">
			<div class="col-md-6 text-center text-md-left g-py-50 g-py-100--md g-px-15 g-px-50--md">
				...
				<div class="landing-block-node-text g-mb-30 g-color-gray-dark-v2"><p>Now that your brand is all dressed up and ready to party, it i<span style="font-size: 1rem;">s time to release it to the world. By the way, let is celebrate already.</span></p></div>
			...
			<div class="landing-block-node-img col-md-6 g-min-height-300 g-bg-img-hero g-px-0 g-bg-size-contain--xs g-bg-size-cover--sm" style="background-image: url(\'https://cdn.bitrix24.site/bitrix/images/landing/business/800x466/img2.jpg\');"></div>
		</div>
	</div>
</section>',
			),
	...
	<div class="landing-block-node-bgimg g-bg-size-cover g-bg-img-hero text-center g-py-170 g-mb-minus-140" style="background-image: url(\'https://cdn.bitrix24.site/bitrix/images/landing/business/1920x800/img2.jpg\');" data-fileid="-1">
		<a class="landing-block-node-button u-icon-v3 u-icon-size--xl u-block-hover--scale g-overflow-inherit g-bg-white g-color-gray-dark-v1 g-color-primary--hover g-font-size-20 rounded-circle g-text-underline--none--hover g-cursor-pointer mb-3" href="//www.youtube.com/watch?v=q4d8g9Dn3ww" target="_popup" data-url="//www.youtube.com/embed/q4d8g9Dn3ww?autoplay=1&amp;controls=1&amp;loop=0&amp;rel=0&amp;start=0&amp;html5=1&amp;v=q4d8g9Dn3ww">
			<img class="landing-block-node-card-icon d-block g-height-20 g-left-2 g-relative-centered--y mr-auto g-ml-37" src="https://cdn.bitrix24.site/bitrix/images/landing/play-black.png" />
		</a>
	...
	<svg class="g-pos-rel" version="1.1" preserveaspectratio="none" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="100%" height="140px" viewbox="20 -20 300 100">
      ...
      c53.07-16.399,104.047,36.903,104.047,36.903l1.333,36.667l-372-2.954L-34.667,62.998z" fill="#fafbfc"></path>
        ...
        <div class="landing-block-inner-container row no-gutters align-items-start">
            ...
            <div class="landing-block-card col-md-6 g-flex-centered landing-card col-lg-3">
                <div class="text-center g-color-gray-light-v2 g-pa-30">
        ...
        <div class="container">
            ...
            <div class="row no-gutters">
                ...
                <div class="landing-block-card js-animation fadeInUp col-md-4 g-mb-30 g-mb-0--md landing-card col-lg-6">
...
<!--                                        <a class="u-icon-v1 u-icon-size--sm u-icon-slide-up--hover g-color-blue g-bg-blue-opacity-0_1 g-color-blue--hover rounded-circle" href="https://www.facebook.com/company24">-->
<!--                                            <i class="g-font-size-default g-line-height-1 u-icon__elem-regular fa fa-facebook"></i>-->
<!--                                            <i class="g-font-size-default g-line-height-0_8 u-icon__elem-hover fa fa-facebook"></i>-->
<!--                                        </a>-->
<!--                                    </li>-->
<!--                                    <li class="list-inline-item g-mx-2">-->
<!--                                        <a class="u-icon-v1 u-icon-size--sm u-icon-slide-up--hover g-color-cyan g-bg-cyan-opacity-0_1 g-color-cyan--hover rounded-circle" href="https://twitter.com/company24">-->
<!--                                            <i class="g-font-size-default g-line-height-1 u-icon__elem-regular fa fa-twitter"></i>-->
<!--                                            <i class="g-font-size-default g-line-height-0_8 u-icon__elem-hover fa fa-twitter"></i>-->
<!--                                        </a>-->
<!--                                    </li>-->
<!--                                    <li class="list-inline-item g-mx-2">-->
<!--                                        <a class="u-icon-v1 u-icon-size--sm u-icon-slide-up--hover g-color-bluegray g-bg-bluegray-opacity-0_1 g-color-bluegray--hover rounded-circle" href="https://github.com/company24">-->
...
<!--                                    </li>-->
<!--                                    <li class="list-inline-item g-mx-2">-->
<!--                                        <a class="u-icon-v1 u-icon-size--sm u-icon-slide-up--hover g-color-red g-bg-red-opacity-0_1 g-color-red--hover rounded-circle" href="https://dribbble.com/company24">-->
...
<!--                                </ul>-->
		...
		'29.three_cols_texts_blocks_slider' =>
			array (
				...
				'SORT' => '7500',
				'CONTENT' => '<section class="landing-block js-animation zoomIn g-bg-secondary">

	<div>
		<div class="container g-py-40">

			<div id="carouselFBK002" class="js-carousel g-pb-60"
				 data-infinite="true"
				 data-autoplay="true"
				 data-pause-hover="true"
				 data-speed="7000"
        ...
        <div class="container g-pt-30 g-pb-20">
            <div class="row">
                ...
                <div class="landing-block-card col-sm-6 col-md-4 g-mb-20">
              ...
              c53.07-16.399,104.047,36.903,104.047,36.903l1.333,36.667l-372-2.954L-34.667,62.998z" fill="#fff" />
                ...
                <div class="landing-block-card col-sm-6 col-md-4 g-mb-30">
                    <article class="u-shadow-v28 g-bg-white">
		...
		'01.big_with_text_2' =>
			array (
				...
				'SORT' => '9000',
				'CONTENT' => '<section class="landing-block landing-block-img g-bg-size-cover g-bg-pos-center" style="background-image: url(https://cdn.bitrix24.site/bitrix/images/landing/business/1920x800/img1.jpg);">
