...
return array(
	...
	'fields' => array(
		'ADDITIONAL_FIELDS' => array(
			...
			'METAOG_IMAGE' => 'https://repo.bitrix24.site/bitrix/images/demo/page/event/preview.jpg',
	...
	'items' => array (
		'0.menu_11_event' =>
			array (
				...
				'SORT' => '-100',
				'CONTENT' => '<header class="landing-block landing-block u-header landing-ui-pattern-transparent u-header--sticky-top u-header--change-appearance g-z-index-9999" data-header-fix-moment="100">
	<div class="light-theme u-header__section g-bg-darkblue-opacity-0_7 g-transition-0_3 g-py-10" data-header-fix-moment-exclude="light-theme g-bg-darkblue-opacity-0_7" data-header-fix-moment-classes="dark-theme g-bg-white-opacity-0_9">
		<nav class="navbar navbar-expand-lg g-py-0">
			<div class="container">
				<!-- Logo -->
				<a href="#" class="landing-block-node-menu-logo-link navbar-brand u-header__logo p-0">
					<img class="landing-block-node-menu-logo u-header__logo-img u-header__logo-img--main d-block g-max-width-180" src="/bitrix/images/landing/logos/event-logo-light.png" alt="" data-header-fix-moment-exclude="d-block" data-header-fix-moment-classes="d-none" />

					<img class="landing-block-node-menu-logo2 u-header__logo-img u-header__logo-img--main d-none g-max-width-180" src="/bitrix/images/landing/logos/event-logo-dark.png" alt="" data-header-fix-moment-exclude="d-none" data-header-fix-moment-classes="d-block" />
				</a>
				<!-- End Logo -->
				...
				<div class="collapse navbar-collapse align-items-center flex-sm-row" id="navBar">
					<ul class="landing-block-node-menu-list js-scroll-nav navbar-nav text-uppercase g-font-weight-700 g-font-size-11 g-pt-20 g-pt-0--lg ml-auto">
						<li class="landing-block-node-menu-list-item nav-item g-mr-15--lg g-mb-7 g-mb-0--lg active">
							<a href="#block@block[41.3.announcement_with_slider]" class="landing-block-node-menu-list-item-link nav-link p-0 g-color-white" target="_self">HOME</a><span class="sr-only">(current)</span>
						</li>
						<li class="landing-block-node-menu-list-item nav-item g-mx-15--lg g-mb-7 g-mb-0--lg">
							<a href="#block@block[36.1.shedule]" class="landing-block-node-menu-list-item-link nav-link p-0 g-color-white" target="_self">SCHEDULE</a>
						</li>
						<li class="landing-block-node-menu-list-item nav-item g-mx-15--lg g-mb-7 g-mb-0--lg">
							<a href="#block@block[27.one_col_fix_title_and_text_2]" class="landing-block-node-menu-list-item-link nav-link p-0 g-color-white" target="_self">about</a>
						</li>
						<li class="landing-block-node-menu-list-item nav-item g-mx-15--lg g-mb-7 g-mb-0--lg">
							<a href="#block@block[01.big_with_text_3]" class="landing-block-node-menu-list-item-link nav-link p-0 g-color-white" target="_self">GUESTS</a>
						</li>
						
						<li class="landing-block-node-menu-list-item nav-item g-mx-15--lg g-mb-7 g-mb-0--lg">
							<a href="#block@block[27.one_col_fix_title_and_text_2@3]" class="landing-block-node-menu-list-item-link nav-link p-0 g-color-white" target="_self">LATEST POSTS</a>
						</li>
						<li class="landing-block-node-menu-list-item nav-item g-mx-15--lg g-mb-7 g-mb-0--lg">
							<a href="#block@block[27.one_col_fix_title_and_text_2@4]" class="landing-block-node-menu-list-item-link nav-link p-0 g-color-white" target="_self">PRICING</a>
						</li>
						<li class="landing-block-node-menu-list-item nav-item g-ml-15--lg">
							<a href="#block@block[33.1.form_1_transparent_black_left_text]" class="landing-block-node-menu-list-item-link nav-link p-0 g-color-white" target="_self">CONTACT</a>
						</li>
					</ul>
				</div>
				<!-- End Navigation -->
			...
			<div class="container u-bg-overlay__inner g-bottom-minus-70 px-0 g-z-index-2">
				<div class="row u-shadow-v23 g-theme-event-bg-blue-dark-v2 mx-0">
					<div class="col-md-6 px-0">
						<div class="js-carousel text-center u-carousel-v5 g-overflow-hidden h-100 g-max-height-50vh" data-infinite="true" data-arrows-classes="u-arrow-v1 g-absolute-centered--y g-width-40 g-height-40 g-font-size-20 g-color-white g-color-primary--hover g-bg-primary g-bg-white--hover g-transition-0_2 g-transition--ease-in" data-arrow-left-classes="fa fa-angle-left g-left-0" data-arrow-right-classes="fa fa-angle-right g-right-0">
		...
		<div class="tab-pane fade active show" role="tabpanel" aria-expanded="true">
			<div class="u-timeline-v3-wrap">
				<div class="landing-block-node-card js-animation u-timeline-v3 d-block text-center text-md-left g-parent u-link-v5 g-mb-50 fadeInUp" href="#">
					...
					<div class="row mx-0">
						<div class="col-md-5 g-order-2 g-order-1--sm d-flex align-items-center flex-wrap flex-sm-nowrap px-0">
						...
						<div class="col-md-7 g-order-1 g-order-2--sm px-0 g-mb-15 g-mb-0--md">
	...
	<div class="container">
		<div class="row">
			...
			<div class="landing-block-card landing-block-node-block col-md-4 g-mb-30 g-mb-0--md g-pt-10 js-animation fadeIn">
				...
				<h3 class="landing-block-node-title text-uppercase g-font-weight-700 g-color-black g-mb-20 g-font-size-14">UI/UX DESIGN</h3>
        ...
        <div class="container">
            ...
            <div class="row no-gutters">
                ...
                <div class="landing-block-card js-animation col-md-4 g-mb-30 g-mb-0--md fadeInUp">
                    <article class="text-center g-brd-around g-color-gray g-brd-gray-light-v5 g-pa-10">
                        <div class="g-bg-gray-light-v5 g-pa-30">
                            <h4 class="landing-block-node-title text-uppercase h5 g-color-gray-dark-v3 g-font-weight-500 g-mb-10">BASIC PASS</h4>
                ...
                <div class="landing-block-card js-animation col-md-4 g-mb-30 g-mb-0--md fadeInUp">
                    <article class="text-center g-brd-around g-color-gray g-brd-gray-light-v5 g-pa-10 g-mt-minus-20">
                        <div class="g-bg-gray-light-v5 g-py-50 g-px-30">
                            <h4 class="landing-block-node-title text-uppercase h5 g-color-gray-dark-v3 g-font-weight-500 g-mb-10">Advanced pass</h4>
                            <div class="landing-block-node-subtitle g-font-style-normal"> </div>
                ...
                <div class="landing-block-card js-animation col-md-4 g-mb-30 g-mb-0--md fadeInUp">
                    <article class="text-center g-brd-around g-color-gray g-brd-gray-light-v5 g-pa-10">
                        <div class="g-bg-gray-light-v5 g-pa-30">
                            <h4 class="landing-block-node-title text-uppercase h5 g-color-gray-dark-v3 g-font-weight-500 g-mb-10">FULL PASS</h4>
                            <div class="landing-block-node-subtitle g-font-style-normal"> </div>
	...
	<div class="container">
		...
		'33.1.form_1_transparent_black_left_text' =>
			array (
				...
				'SORT' => '6500',
				'CONTENT' => '<section class="landing-block g-pos-rel g-pt-120 g-pb-120 landing-block-node-bgimg g-bg-size-cover g-bg-img-hero g-bg-cover g-bg-black-opacity-0_7--after" style="background-image: url(\'https://cdn.bitrix24.site/bitrix/images/landing/business/1600x827/img1.jpg\');" data-fileid="-1">
		...
		<div class="container g-pos-rel g-z-index-1">
			<div class="row align-items-center">
				...
				<div class="col-md-4">
					<h2 class="landing-block-node-main-title h1 g-color-white mb-4 js-animation fadeInUp animated g-font-size-24"><span style="font-weight: bold;">CONTACT | <span style="color: rgb(247, 56, 89);">INFORMATION</span></span></h2>
					
					<div class="landing-block-node-text g-line-height-1_5 text-left g-mb-40 g-color-white-opacity-0_6 js-animation fadeInUp animated" data-form-style-main-font-family="1" data-form-style-main-font-weight="1" data-form-style-header-text-font-size="1" data-selector=".landing-block-node-text@0"><p>
					...
					<div class="landing-block-node-card-contact">
						<div class="media align-items-center mb-4">
							...
							<div class="media-body">
								<div class="landing-block-node-contact-text g-color-white-opacity-0_6 mb-0" data-form-style-main-font-weight="1" data-form-style-header-text-font-size="1" data-form-style-label-font-weight="1" data-form-style-label-font-size="1" data-form-style-second-font-color="1">5B Streat, City 50987 New Town US</div>
							</div>
						</div>
					</div>
					<!-- End Icon Block -->
					...
					<div class="landing-block-node-card-contact">
						<div class="media align-items-center mb-4">
							...
							<div class="media-body">
								<div class="g-color-white-opacity-0_6 mb-0" data-form-style-main-font-weight="1" data-form-style-header-text-font-size="1" data-form-style-label-font-weight="1" data-form-style-label-font-size="1" data-form-style-second-font-color="1"><a href="tel:+32(0)333444555" class="landing-block-node-contact-link g-color-white-opacity-0_6">
										+32 (0) 333 444 555</a>
								</div>
							</div>
						</div>
