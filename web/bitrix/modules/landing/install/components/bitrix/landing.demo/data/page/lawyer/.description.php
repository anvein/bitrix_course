...
return array(
	...
	'fields' => array(
		'ADDITIONAL_FIELDS' => array(
			...
			'METAOG_IMAGE' => 'https://repo.bitrix24.site/bitrix/images/demo/page/lawyer/preview.jpg',
...
<header class="landing-block landing-block-menu g-bg-white u-header u-header--sticky-top u-header--change-appearance g-z-index-9999"
	...
	<div class="u-header__section g-transition-0_3 g-py-6 g-py-18--md"
			...
			<div class="container">
				<!-- Logo -->
					...
					<img class="landing-block-node-menu-logo u-header__logo-img u-header__logo-img--main g-max-width-180"
						 src="/bitrix/images/landing/logos/lawyer-logo.png" alt="">
				</a>
				<!-- End Logo -->
				...
				<div class="collapse navbar-collapse align-items-center flex-sm-row" id="navBar">
					<ul class="landing-block-node-menu-list js-scroll-nav navbar-nav text-uppercase g-font-weight-700 g-font-size-11 g-pt-20 g-pt-0--lg ml-auto">
						...
						<li class="landing-block-node-menu-list-item nav-item g-ml-15--lg">
							<a href="#block@block[33.10.form_2_light_left_text]" class="landing-block-node-menu-list-item-link nav-link p-0">Contact</a>
						</li>
					</ul>
				</div>
				<!-- End Navigation -->
	...
	<div class="container g-max-width-800 text-center u-bg-overlay__inner g-mx-1 js-animation landing-block-node-container fadeInDown animated">
		<h2 class="landing-block-node-title text-uppercase g-line-height-1 g-font-weight-700 g-font-size-30 g-color-white g-mb-20 g-font-size-55">THE LAW <br />MUST WORK</h2>
		...
		<div class="landing-block-node-button-container">
			<a href="#" class="landing-block-node-button btn btn-xl text-uppercase g-font-weight-700 g-font-size-12 g-py-15 g-px-40 g-mb-15 u-btn-outline-white rounded-0" target="_self">LEARN MORE</a>
		</div>
	</div>
</section>',
			),
            ...
            <div class="landing-block-node-center col-md-6 col-lg-4 g-flex-centered g-theme-lawyer-bg-gray-dark-v1">
                <div class="text-center g-color-gray-light-v2 g-pa-30">
                    <div class="landing-block-node-header text-uppercase u-heading-v2-4--bottom g-brd-primary g-mb-40">
                        <h4 class="landing-block-node-center-subtitle js-animation fadeIn h6 g-font-weight-800 g-font-size-12 g-letter-spacing-1 g-color-primary g-mb-20 animated">About us</h4>
            ...
            <div class="col-md-6 col-lg-4 landing-block-node-right g-bg-main">
                <div class="js-carousel g-pb-90" data-infinite="true" data-slides-show="true" data-pagi-classes="u-carousel-indicators-v1 g-absolute-centered--x g-bottom-30">
                    ...
                    <div class="js-slide landing-block-card-right">
                        ...
                        <div class="g-pa-30">
                            <h3 class="landing-block-node-right-title js-animation fadeIn text-uppercase g-font-weight-700 g-font-size-20 g-color-white g-mb-10 animated">WE ARE WINNERS</h3>
                            <div class="landing-block-node-right-text js-animation fadeIn g-color-gray-light-v2 animated">
                    ...
                    <div class="js-slide landing-block-card-right">
                        ...
                        <div class="g-pa-30">
                            <h3 class="landing-block-node-right-title js-animation fadeIn text-uppercase g-font-weight-700 g-font-size-20 g-color-white g-mb-10 animated">WE ARE THE BEST</h3>
                            <div class="landing-block-node-right-text js-animation fadeIn g-color-gray-light-v2 animated">
								<p>Etiam consectetur placerat gravida. Pellentesque ultricies mattis est, quis elementum neque pulvinar at.</p>
                            	<p>Aenean odio ante, varius vel tempor sed Ut condimentum ex ac enim ullamcorper volutpat. Integer arcu nisl, finibus vitae sodales vitae, malesuada ultricies sapien.</p>
							</div>
        ...
        <div class="container landing-block-node-subcontainer text-center g-max-width-800 g-mb-20">
			...
			<div class="landing-block-node-text g-color-gray-dark-v3"><p>Sed feugiat porttitor nunc, non dignissim ipsum vestibulum in. Donec in blandit dolor. Vivamus a fringilla lorem, vel faucibus ante. Nunc ullamcorper, justo a iaculis elementum, enim orci viverra eros, fringilla porttitor lorem eros vel</p></div>
        </div>
	...
	<div>
		<div class="row mx-0">
			...
			<div class="landing-block-node-img col-md-6 g-min-height-360 g-bg-img-hero g-px-0 g-bg-size-contain--xs g-bg-size-cover--sm" style="background-image: url(\'https://cdn.bitrix24.site/bitrix/images/landing/business/1200x914/img1.jpg\');" data-fileid="-1" data-filehash="9eef207add73028ae50f74a9033c20cb"></div>
		</div>
	</div>
</section>',
			),
	...
	<div>
        ...
        <div class="container landing-block-node-subcontainer text-center g-max-width-800 g-mb-20">
            ...
            <div class="landing-block-node-inner text-uppercase u-heading-v2-4--bottom g-brd-primary">
                <h4 class="landing-block-node-subtitle g-font-weight-700 g-font-size-12 g-color-primary g-mb-15"></h4>
                <h2 class="landing-block-node-title u-heading-v2__title g-line-height-1_1 g-font-weight-700 g-font-size-40 g-color-black g-mb-minus-10">OUR CASES</h2>
            </div>
	...
	<div class="container">
				...
				<div class="text-center">
					...
					<figure class="g-pos-rel g-parent g-mb-30">
						...
						<figcaption class="g-pos-abs g-top-0 g-left-0 g-flex-middle w-100 h-100 g-bg-primary-opacity-0_8 opacity-0 g-opacity-1--parent-hover g-pa-20 g-transition-0_2 g-transition--ease-in">
							<div class="landing-block-node-employee-quote text-uppercase g-flex-middle-item g-line-height-1_4 g-font-weight-700 g-font-size-16 g-color-white"><br /></div>
					...
					<h4 class="landing-block-node-employee-name text-uppercase g-font-weight-700 g-font-size-18 g-color-gray-dark-v2 g-mb-7">Ralf
						Smith</h4>
					<p class="landing-block-node-employee-subtitle g-font-size-13 g-color-gray-dark-v5 mb-0">civil and criminal law</p>
					<!-- End Figure Info-->
				</div>
			</div>
			...
			<div class="landing-block-card-employee js-animation col-md-6 g-mb-30 g-mb-0--lg landing-card col-lg-4 fadeIn animated">
				<div class="text-center">
					...
					<h4 class="landing-block-node-employee-name text-uppercase g-font-weight-700 g-font-size-18 g-color-gray-dark-v2 g-mb-7">Monica
						Gaudy</h4>
					<p class="landing-block-node-employee-subtitle g-font-size-13 g-color-gray-dark-v5 mb-0">business and criminal law</p>
					<!-- End Figure Info-->
				</div>
			</div>
			...
			<div class="landing-block-card-employee js-animation col-md-6 g-mb-30 g-mb-0--lg landing-card col-lg-4 fadeIn animated">
				<div class="text-center">
					...
					<h4 class="landing-block-node-employee-name text-uppercase g-font-weight-700 g-font-size-18 g-color-gray-dark-v2 g-mb-7">Julia
						Exon</h4>
					<p class="landing-block-node-employee-subtitle g-font-size-13 g-color-gray-dark-v5 mb-0">criminal law</p>
					<!-- End Figure Info-->
				</div>
			</div>
        ...
        <div class="container">
				<a class="landing-block-node-button btn btn-md text-uppercase u-btn-primary rounded-0 g-px-15" href="#" g-font-weight-700 target="_self">CONTACT US</a>
        </div>
    </section>',
			),
        ...
        <div id="carouselFBK001" class="js-carousel" data-autoplay="true" data-infinite="true" data-slides-show="4">
            <div class="landing-block-card-carousel-element js-slide g-pt-60 g-pb-5 g-px-15">
                <div class="text-center u-shadow-v10 g-bg-white g-pa-0-35-35--sm g-pa-0-20-20">
                    ...
                    <h4 class="landing-block-node-title text-uppercase g-font-weight-700 g-font-size-default mb-0">Fred Penner</h4>
                    <div class="landing-block-node-subtitle text-uppercase g-font-style-normal g-font-weight-700 g-font-size-10 g-color-gray-dark-v5">Ruma</div>
                    <blockquote class="landing-block-node-text u-blockquote-v7 g-line-height-1_5 g-color-gray-dark-v5 g-bg-primary--before mb-0">&quot;Ut augue diam, lacinia fringilla erat eu, vehicula commodo quam. Aliquam eget accumsan ligula. Maecenas sit amet consectetur lectus. Suspendisse commodo et magna non pulvinar.&quot;</blockquote>
                </div>
            </div>
            ...
            <div class="landing-block-card-carousel-element js-slide g-pt-60 g-pb-5 g-px-15">
                <div class="text-center u-shadow-v10 g-bg-white g-pa-0-35-35--sm g-pa-0-20-20">
                    ...
                    <h4 class="landing-block-node-title text-uppercase g-font-weight-700 g-font-size-default mb-0">Amy Clayton</h4>
                    <div class="landing-block-node-subtitle text-uppercase g-font-style-normal g-font-weight-700 g-font-size-10 g-color-gray-dark-v5">Abibas</div>
            ...
            <div class="landing-block-card-carousel-element js-slide g-pt-60 g-pb-5 g-px-15">
                <div class="text-center u-shadow-v10 g-bg-white g-pa-0-35-35--sm g-pa-0-20-20">
                    ...
                    <h4 class="landing-block-node-title text-uppercase g-font-weight-700 g-font-size-default mb-0">Martina Saiz</h4>
                    <div class="landing-block-node-subtitle text-uppercase g-font-style-normal g-font-weight-700 g-font-size-10 g-color-gray-dark-v5">Jonda</div>
                    <blockquote class="landing-block-node-text u-blockquote-v7 g-line-height-1_5 g-color-gray-dark-v5 g-bg-primary--before mb-0">&quot;Ut augue diam, lacinia fringilla erat eu, vehicula commodo quam. Aliquam eget accumsan ligula. Maecenas sit amet consectetur lectus. Suspendisse commodo et magna non pulvinar.&quot;</blockquote>
                </div>
            </div>
            ...
            <div class="landing-block-card-carousel-element js-slide g-pt-60 g-pb-5 g-px-15">
                <div class="text-center u-shadow-v10 g-bg-white g-pa-0-35-35--sm g-pa-0-20-20">
                    ...
                    <h4 class="landing-block-node-title text-uppercase g-font-weight-700 g-font-size-default mb-0">Joseph B. Seward</h4>
                    <div class="landing-block-node-subtitle text-uppercase g-font-style-normal g-font-weight-700 g-font-size-10 g-color-gray-dark-v5">Aodi</div>
                    <blockquote class="landing-block-node-text u-blockquote-v7 g-line-height-1_5 g-color-gray-dark-v5 g-bg-primary--before mb-0">&quot;Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt.&quot;</blockquote>
                </div>
            </div>
            ...
            <div class="landing-block-card-carousel-element js-slide g-pt-60 g-pb-5 g-px-15">
                <div class="text-center u-shadow-v10 g-bg-white g-pa-0-35-35--sm g-pa-0-20-20">
                    ...
                    <h4 class="landing-block-node-title text-uppercase g-font-weight-700 g-font-size-default mb-0">Julia B. Mcraflane</h4>
                    <div class="landing-block-node-subtitle text-uppercase g-font-style-normal g-font-weight-700 g-font-size-10 g-color-gray-dark-v5">Spencet Group</div>
                    <blockquote class="landing-block-node-text u-blockquote-v7 g-line-height-1_5 g-color-gray-dark-v5 g-bg-primary--before mb-0">&quot;Maecenas sit amet consectetur lectus. Suspendisse commodo et magna non pulvinar. Quisque et ultricies sem, et vulputate dui. Morbi aliquam leo id ipsum tempus mollis.&quot;</blockquote>
                </div>
            </div>
        ...
        <div class="container">
            ...
            <div id="carouselGLR003" class="js-carousel g-mb-20" data-autoplay="true" data-infinite="true" data-slides-show="6">
            ...
            <div class="row">
              ...
              c53.07-16.399,104.047,36.903,104.047,36.903l1.333,36.667l-372-2.954L-34.667,62.998z" fill="#fff" />
                            ...
                            <div class="g-pos-rel g-z-index-1 g-pa-30">
                                <h3 class="h5 mb-3">
                                    <a class="landing-block-node-link u-link-v5 g-color-main g-color-primary--hover" href="#" target="_self">MAURIS TELLUS MAGNA, PRETIUM</a>
                                </h3>
              ...
              c53.07-16.399,104.047,36.903,104.047,36.903l1.333,36.667l-372-2.954L-34.667,62.998z" fill="#fff" />
                            ...
                            <div class="g-pos-rel g-z-index-1 g-pa-30">
                                <h3 class="h5 mb-3">
                                    <a class="landing-block-node-link u-link-v5 g-color-main g-color-primary--hover" href="#" target="_self">PROIN EGESTAS PURUS EGET PULVINAR</a>
                                </h3>
                                <a class="landing-block-node-link-more u-link-v5 g-color-text g-color-primary--hover g-font-weight-500" href="#" target="_self">READ MORE</a>
                            </div>
                        </div>
		...
		'33.10.form_2_light_left_text' =>
			array (
				...
				'SORT' => '8500',
				'CONTENT' => '<section class="g-pos-rel landing-block text-center g-color-gray-dark-v1 g-py-100 g-theme-lawyer-bg-gray-dark-v1">
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-md-6">
				<div class="text-center g-overflow-hidden">
					<div class="landing-block-node-text g-line-height-1_5 text-left g-mb-40 g-color-lightblue" data-form-style-main-font-family="1" data-form-style-main-font-weight="1" data-form-style-header-text-font-size="1"><p style="text-align: center;"><span style="font-weight: bold;">CONTACT US</span></p></div>
					<div class="g-mx-minus-2 g-my-minus-2">
						<div class="row mx-0">
							<div class="landing-block-card-contact col-sm-6 g-brd-left g-brd-bottom g-brd-gray-light-v4 g-px-15 g-py-25 js-animation fadeIn">
								...
								<h3 class="landing-block-card-contact-title text-uppercase g-font-size-11 mb-0 g-color-white" data-form-style-label-font-weight="1" data-form-style-label-font-size="1" data-form-style-second-font-color="1">Address</h3>
								<div class="landing-block-card-contact-text g-font-size-11 g-color-lightblue"><span style="font-weight: bold;">Sit amet adipiscing</span></div>
							</div>

							<div class="landing-block-card-contact col-sm-6 g-brd-left g-brd-bottom g-brd-gray-light-v4 g-px-15 g-py-25 js-animation fadeIn">
								<i class="landing-block-card-contact-icon icon-call-in d-inline-block g-font-size-50 g-color-primary g-mb-30"></i>
								<h3 class="landing-block-card-contact-title text-uppercase g-font-size-11 mb-0 g-color-white" data-form-style-label-font-weight="1" data-form-style-label-font-size="1" data-form-style-second-font-color="1">Phone
									number</h3>
								<div class="g-font-size-11 g-color-lightblue">
							...
							<div class="landing-block-card-contact col-sm-6 g-brd-left g-brd-bottom g-brd-gray-light-v4 g-px-15 g-py-25 js-animation fadeIn">
								...
								<h3 class="landing-block-card-contact-title text-uppercase g-font-size-11 mb-0 g-color-white" data-form-style-label-font-weight="1" data-form-style-label-font-size="1" data-form-style-second-font-color="1">Email</h3>
								<div class="g-font-size-11 g-color-lightblue">
							...
							<div class="landing-block-card-contact col-sm-6 g-brd-left g-brd-bottom g-brd-gray-light-v4 g-px-15 g-py-25 js-animation fadeIn">
								...
								<h3 class="landing-block-card-contact-title text-uppercase g-font-size-11 mb-0 g-color-white" data-form-style-label-font-weight="1" data-form-style-label-font-size="1" data-form-style-second-font-color="1">Toll
									free</h3>
								<div class="g-font-size-11 g-color-lightblue">
		...
		'35.1.footer_light' =>
			array (
				...
				'SORT' => '9000',
				'CONTENT' => '<section class="g-color-gray-dark-v2 g-py-60">
	<div class="container">
		<div class="row">
			<div class="col-sm-12 col-md-6 col-lg-6 g-mb-25 g-mb-0--lg">
				...
				<address class="g-color-gray-dark-v2 g-mb-20">
					<div class="landing-block-card-contact g-pos-rel g-pl-20 g-mb-7">
						...
						<div class="landing-block-node-card-contact-text">Address: In sed lectus tincidunt</div>
					</div>
