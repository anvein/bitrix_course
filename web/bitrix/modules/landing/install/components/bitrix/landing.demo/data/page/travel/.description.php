...
return array(
	...
	'fields' => array(
		'ADDITIONAL_FIELDS' => array(
			...
			'METAOG_IMAGE' => 'https://repo.bitrix24.site/bitrix/images/demo/page/travel/preview.jpg',
	...
	'items' => array (
		'0.menu_19_travel' =>
			array (
				...
				'SORT' => '-100',
				'CONTENT' => '<header class="landing-block landing-ui-pattern-transparent landing-block-menu u-header u-header--sticky-top u-header--change-appearance" data-header-fix-moment="100">
	<div class="u-header__section g-transition-0_3 g-py-12" data-header-fix-moment-exclude="g-py-12" data-header-fix-moment-classes="g-theme-travel-bg-black-v1-opacity-0_8 g-py-7">
		<nav class="navbar navbar-expand-lg g-py-0">
			<div class="container">
				<!-- Logo -->
				<a href="#" class="navbar-brand landing-block-node-menu-logo-link u-header__logo p-0" target="_self">
					<img class="landing-block-node-menu-logo u-header__logo-img u-header__logo-img--main g-max-width-180" src="/bitrix/images/landing/logos/travel-logo.png" alt="" />
				</a>
				<!-- End Logo -->
				...
				<div class="collapse navbar-collapse align-items-center flex-sm-row" id="navBar">
					<ul class="landing-block-node-menu-list js-scroll-nav navbar-nav text-uppercase g-font-weight-700 g-font-size-11 g-pt-20 g-pt-0--lg ml-auto">
						<li class="landing-block-node-menu-list-item nav-item g-mr-15--lg g-mb-7 g-mb-0--lg active">
							<a href="#block@block[04.1.one_col_fix_with_title]" class="landing-block-node-menu-list-item-link nav-link p-0 g-color-white" target="_self">Our
								tours</a><span class="sr-only">(current)</span>
						</li>
						<li class="landing-block-node-menu-list-item nav-item g-mx-15--lg g-mb-7 g-mb-0--lg">
							<a href="#block@block[04.7.one_col_fix_with_title_and_text_2]" class="landing-block-node-menu-list-item-link nav-link p-0 g-color-white" target="_self">Popular
								tours</a>
						</li>
						<li class="landing-block-node-menu-list-item nav-item g-mx-15--lg g-mb-7 g-mb-0--lg">
							<a href="#block@block[01.big_with_text_3]" class="landing-block-node-menu-list-item-link nav-link p-0 g-color-white" target="_self">Discount</a>
						</li>
						<li class="landing-block-node-menu-list-item nav-item g-mx-15--lg g-mb-7 g-mb-0--lg">
							<a href="#block@block[04.7.one_col_fix_with_title_and_text_2@2]" class="landing-block-node-menu-list-item-link nav-link p-0 g-color-white" target="_self">Purposes</a>
						</li>
						<li class="landing-block-node-menu-list-item nav-item g-mx-15--lg g-mb-7 g-mb-0--lg">
							<a href="#block@block[04.7.one_col_fix_with_title_and_text_2@3]" class="landing-block-node-menu-list-item-link nav-link p-0 g-color-white" target="_self">Services</a>
						</li>
						<li class="landing-block-node-menu-list-item nav-item g-mx-15--lg g-mb-7 g-mb-0--lg">
							<a href="#block@block[04.7.one_col_fix_with_title_and_text_2@4]" class="landing-block-node-menu-list-item-link nav-link p-0 g-color-white" target="_self">Gallery</a>
						</li>
						<li class="landing-block-node-menu-list-item nav-item g-mx-15--lg g-mb-7 g-mb-0--lg">
							<a href="#block@block[04.7.one_col_fix_with_title_and_text_2@5]" class="landing-block-node-menu-list-item-link nav-link p-0 g-color-white" target="_self">Testimonials</a>
						</li>
						<li class="landing-block-node-menu-list-item nav-item g-mx-15--lg g-mb-7 g-mb-0--lg">
							<a href="#block@block[27.one_col_fix_title_and_text_2]" class="landing-block-node-menu-list-item-link nav-link p-0 g-color-white" target="_self">Contact</a>
						</li>
					</ul>
				</div>
				<!-- End Navigation -->
	...
	<div class="js-carousel carouselTravel2 g-px-25" data-infinite="true" data-slides-show="5" data-arrows-classes="u-arrow-v1 g-absolute-centered--y g-width-45 g-height-45 g-font-size-default g-color-white g-bg-primary g-color-primary--hover g-bg-white--hover" data-arrow-left-classes="fa fa-chevron-left g-left-0" data-arrow-right-classes="fa fa-chevron-right g-right-0">
		<div class="landing-block-node-card js-slide g-px-7">
			<div class="g-pos-rel g-text-underline--none--hover g-parent g-theme-travel-bg-black-v1 g-bg-primary--hover g-color-white g-transition-0_3" href="#">
				...
				<div class="g-pa-20">
					<div class="g-mb-20">
						<h3 class="landing-block-node-card-title text-uppercase g-font-weight-700 g-font-size-default g-font-roboto-slab g-color-white g-mb-5 js-animation fadeInRight animated">
							Crete</h3>

						<div hidden="" class="js-rating info-v5-6__rating g-transition-0_3 g-color-primary g-theme-color-black-v1--parent-hover g-font-size-default g-mb-10" data-rating="2.5" data-spacing="5"></div>

						<div class="landing-block-node-card-text g-color-white-opacity-0_8 js-animation fadeInLeft animated">
							<p>dapibus quis sapien id phar etra iaculis est</p>
						</div>
					</div>

					<div class="landing-block-node-card-price d-inline-block g-line-height-1 g-font-weight-700 g-font-size-11 g-bg-primary g-color-primary--parent-hover g-bg-white--parent-hover g-pa-10 js-animation fadeInRight" href="#">$350.00
					</div>
				</div>
			</div>
		</div>
		...
		<div class="landing-block-node-card js-slide g-px-7">
			<div class="g-pos-rel g-text-underline--none--hover g-parent g-theme-travel-bg-black-v1 g-bg-primary--hover g-color-white g-transition-0_3" href="#">
				<img class="landing-block-node-card-img img-fluid" src="https://cdn.bitrix24.site/bitrix/images/landing/business/600x600/img2.jpg" alt="" />
				...
				<div class="g-pa-20">
					<div class="g-mb-20">
						...
						<div hidden="" class="js-rating info-v5-6__rating g-transition-0_3 g-color-primary g-theme-color-black-v1--parent-hover g-font-size-default g-mb-10" data-rating="3" data-spacing="5"></div>
		...
		<div class="landing-block-node-card js-slide g-px-7">
			<div class="g-pos-rel g-text-underline--none--hover g-parent g-theme-travel-bg-black-v1 g-bg-primary--hover g-color-white g-transition-0_3" href="#">
				<img class="landing-block-node-card-img img-fluid" src="https://cdn.bitrix24.site/bitrix/images/landing/business/600x600/img3.jpg" alt="" />
				...
				<div class="g-pa-20">
					<div class="g-mb-20">
						...
						<div hidden="" class="js-rating info-v5-6__rating g-transition-0_3 g-color-primary g-theme-color-black-v1--parent-hover g-font-size-default g-mb-10" data-rating="5" data-spacing="5"></div>
		...
		<div class="landing-block-node-card js-slide g-px-7">
			<div class="g-pos-rel g-text-underline--none--hover g-parent g-theme-travel-bg-black-v1 g-bg-primary--hover g-color-white g-transition-0_3" href="#">
				<img class="landing-block-node-card-img img-fluid" src="https://cdn.bitrix24.site/bitrix/images/landing/business/600x600/img4.jpg" alt="" />
				...
				<div class="g-pa-20">
					<div class="g-mb-20">
						...
						<div hidden="" class="js-rating info-v5-6__rating g-transition-0_3 g-color-primary g-theme-color-black-v1--parent-hover g-font-size-default g-mb-10" data-rating="3.5" data-spacing="5"></div>
		...
		<div class="landing-block-node-card js-slide g-px-7">
			<div class="g-pos-rel g-text-underline--none--hover g-parent g-theme-travel-bg-black-v1 g-bg-primary--hover g-color-white g-transition-0_3" href="#">
				<img class="landing-block-node-card-img img-fluid" src="https://cdn.bitrix24.site/bitrix/images/landing/business/600x600/img	5.jpg" alt="" />
				...
				<div class="g-pa-20">
					<div class="g-mb-20">
						...
						<div hidden="" class="js-rating info-v5-6__rating g-transition-0_3 g-color-primary g-theme-color-black-v1--parent-hover g-font-size-default g-mb-10" data-rating="4" data-spacing="5"></div>
					...
					<div class="u-bg-overlay__inner g-pos-abs g-top-0 g-left-0 w-100 h-100 g-pa-10">
						<div class="landing-block-node-card-bg-hover g-flex-middle h-100 g-theme-travel-bg-black-v1-opacity-0_8--hover g-pa-10 g-transition-0_2 g-transition--ease-in">
							<div class="g-flex-middle-item--top">
								<div class="landing-block-node-card-price g-font-weight-700 u-ribbon-v1 text-uppercase g-top-20 g-left-20 g-color-white g-theme-travel-bg-black-v1 g-pa-5" href="#">From
							...
							<div class="text-uppercase g-flex-middle-item--bottom">
								...
								<h3 class="landing-block-node-card-title h5 g-line-height-1_2 g-font-weight-700 g-font-size-18 g-font-roboto-slab g-color-white g-mb-10">
									King Way
								</h3>
	...
	<div class="container g-max-width-800 text-center u-bg-overlay__inner g-mx-1 js-animation landing-block-node-container fadeInDown">
        ...
        <div class="container text-center g-max-width-800 g-mb-20">
            ...
            <div class="landing-block-node-inner text-uppercase u-heading-v2-4--bottom g-brd-primary">
                <h4 class="landing-block-node-subtitle g-font-weight-700 g-mb-15 g-color-black g-font-size-14">SPECIAL PURPOSES</h4>
	...
	<div class="container">
		...
		<div class="row">
			<div class="landing-block-node-card col-md-6 g-mb-30 landing-card col-lg-6 js-animation fadeInUp animated">
				...
				<div class="u-bg-overlay h-100 g-bg-black-opacity-0_3--after g-parent g-text-underline--none--hover" href="#">
					...
					<!-- Article Content -->
					<div class="u-bg-overlay__inner g-pos-abs g-top-0 g-left-0 w-100 h-100 g-pa-10">
						<div class="landing-block-node-card-bg-hover g-flex-middle h-100 g-pa-10 g-transition-0_2 g-transition--ease-in g-bg-primary-opacity-0_8--hover">
							<div class="g-flex-middle-item--top">
								<div class="landing-block-node-card-price g-font-weight-700 u-ribbon-v1 text-uppercase g-top-20 g-left-20 g-theme-travel-bg-black-v1 g-pa-5 g-color-white text-center" href="#"><span style="">$350.00</span></div>
							</div>

							<div class="text-uppercase g-flex-middle-item--bottom">
								<div class="landing-block-node-card-subtitle g-line-height-1_2 g-font-weight-700 g-font-size-11 g-font-roboto-slab g-color-white g-mb-10 text-center">GREECE</div>
								<h3 class="landing-block-node-card-title h5 g-line-height-1_2 g-font-weight-700 g-font-size-18 g-font-roboto-slab g-color-white g-mb-10 text-center">HEAVEN ON EARTH<br /></h3>
								<div class="landing-block-node-card-text small g-color-white-opacity-0_8"><br /></div>
							</div>
						</div>
					</div>
					<!-- End Article Content -->
			...
			<div class="landing-block-node-card col-md-6 g-mb-30 landing-card col-lg-6 js-animation fadeInUp animated">
				...
				<div class="u-bg-overlay h-100 g-bg-black-opacity-0_3--after g-parent g-text-underline--none--hover" href="#">
					...
					<div class="u-bg-overlay__inner g-pos-abs g-top-0 g-left-0 w-100 h-100 g-pa-10">
						<div class="landing-block-node-card-bg-hover g-flex-middle h-100 g-pa-10 g-transition-0_2 g-transition--ease-in g-bg-primary-opacity-0_8--hover">
							<div class="g-flex-middle-item--top">
								<div class="landing-block-node-card-price g-font-weight-700 u-ribbon-v1 text-uppercase g-top-20 g-left-20 g-theme-travel-bg-black-v1 g-pa-5 g-color-white text-center" href="#"><span style="">$800.00</span></div>
							</div>

							<div class="text-uppercase g-flex-middle-item--bottom">
								<div class="landing-block-node-card-subtitle g-line-height-1_2 g-font-weight-700 g-font-size-11 g-font-roboto-slab g-color-white g-mb-10 text-center">ITALY</div>
								<h3 class="landing-block-node-card-title h5 g-line-height-1_2 g-font-weight-700 g-font-size-18 g-font-roboto-slab g-color-white g-mb-10 text-center">AMAZING VENICE</h3>
								<div class="landing-block-node-card-text small g-color-white-opacity-0_8"> </div>
							</div>
						</div>
					</div>
					<!-- End Article Content -->
        ...
        <div class="container text-center g-max-width-800 g-mb-20">
            ...
            <div class="landing-block-node-inner text-uppercase u-heading-v2-4--bottom g-brd-primary">
                ...
                <h2 class="landing-block-node-title u-heading-v2__title g-line-height-1_1 g-font-weight-700 g-font-size-40 g-mb-minus-10 g-color-primary">WHAT WE <span style="color: rgb(33, 33, 33);">PURPOSE</span></h2>
            </div>
...
<!--	</div>-->
	...
	<div class="row no-gutters js-gallery-cards">
        ...
        <div id="carouselFBK001" class="js-carousel" data-autoplay="true" data-pause-hover="true" data-infinite="true" data-slides-show="4">
