...
return array(
	...
	'fields' => array(
		'ADDITIONAL_FIELDS' => array(
		    'METAOG_IMAGE' => 'https://repo.bitrix24.site/bitrix/images/demo/page/holidays/holiday.valentine3/preview.jpg',
			'THEME_CODE' => 'travel',
			...
			<div class="container">
				...
				<a href="#" class="navbar-brand landing-block-node-menu-logo-link u-header__logo">
					<img class="landing-block-node-menu-logo u-header__logo-img u-header__logo-img--main g-max-width-180"
						 src="/bitrix/images/landing/logos/valentine-logo-black.png" alt="">
				</a>
				<!-- End Logo -->
				...
				<div class="collapse navbar-collapse align-items-center flex-sm-row" id="navBar">
					<ul class="landing-block-node-menu-list js-scroll-nav navbar-nav text-uppercase g-font-weight-700 g-font-size-11 g-pt-20 g-pt-0--lg ml-auto">
						...
						<li class="landing-block-node-menu-list-item nav-item g-ml-25--lg">
							<a href="#block@block[35.1.footer_light]" class="landing-block-node-menu-list-item-link nav-link p-0">Contact</a>
						</li>
					</ul>
				</div>
				<!-- End Navigation -->
	...
	<div class="container">
		<div class="landing-block-node-bgimg g-bg-cover g-bg-pos-top-center g-bg-img-hero g-bg-black-opacity-0_1--after g-px-20 g-py-200" style="background-image: url(\'https://cdn.bitrix24.site/bitrix/images/landing/business/1600x1068/img2.jpg\');" data-fileid="-1" data-filehash="9eef207add73028ae50f74a9033c20cb">
			<div class="text-center g-pos-rel g-z-index-1 landing-block-node-container js-animation zoomIn">
				...
				<h2 class="landing-block-node-title h2 d-inline-block g-brd-around g-brd-2 g-brd-white g-color-white g-font-weight-700 g-font-size-40 text-uppercase g-line-height-1_2 g-letter-spacing-5 g-py-12 g-px-20 g-mb-50">Happy Valentine&amp;#039;s day!</h2>
						...
						<div class="landing-block-node-img-title-container w-100 g-pos-abs g-bottom-0 g-left-0 g-top-0
							...
							<article class="landing-block-node-img-title-border h-100 g-flex-middle text-center
								...
								<div class="g-flex-middle-item">
									<h3 class="landing-block-node-img-title g-color-white h3 g-line-height-1_4 g-letter-spacing-5 g-font-size-20 g-mb-20">travelling</h3>
					...
					<div class="landing-block-node-img-container h-100 g-pos-rel g-parent u-block-hover js-animation fadeIn">
						...
						<div class="landing-block-node-img-title-container w-100 g-pos-abs g-bottom-0 g-left-0 g-top-0
							...
							<article class="landing-block-node-img-title-border h-100 g-flex-middle text-center
								g-brd-around g-brd-white-opacity-0_2 text-uppercase g-color-white">
								<div class="g-flex-middle-item">
									<h3 class="landing-block-node-img-title g-color-white h3 g-line-height-1_4 g-letter-spacing-5 g-font-size-20 g-mb-20">candies</h3>
									<div class="landing-block-node-img-text g-letter-spacing-3 g-font-weight-300 g-mb-40">
		...
		<div class="js-gallery-cards row">
			<div class="landing-block-node-card text-center col-lg-3 col-md-4 col-sm-6 g-mb-30 js-animation slideInUp">
				<div class="g-pos-rel g-parent d-inline-block h-100">
					...
					<div class="landing-block-node-card-title-container w-100 g-pos-abs g-bottom-0 g-left-0 g-flex-middle g-bg-primary-opacity-0_9 opacity-0 g-opacity-1--parent-hover g-pa-20 g-transition-0_2 g-transition--ease-in">
						<h3 class="landing-block-node-card-title h3 g-color-white g-font-size-12">VIDEO VALENTINE</h3>
			...
			<div class="landing-block-node-card text-center col-lg-3 col-md-4 col-sm-6 g-mb-30 js-animation slideInUp">
				<div class="g-pos-rel g-parent d-inline-block h-100">
					...
					<div class="landing-block-node-card-title-container w-100 g-pos-abs g-bottom-0 g-left-0 g-flex-middle g-bg-primary-opacity-0_9 opacity-0 g-opacity-1--parent-hover g-pa-20 g-transition-0_2 g-transition--ease-in">
						<h3 class="landing-block-node-card-title h3 g-color-white g-font-size-12">PAPER VALENTINE</h3>
						<div class="landing-block-node-card-subtitle g-color-white"> </div>
					</div>
				</div>
			</div>
			...
			<div class="landing-block-node-card text-center col-lg-3 col-md-4 col-sm-6 g-mb-30 js-animation slideInUp">
				<div class="g-pos-rel g-parent d-inline-block h-100">
					...
					<div class="landing-block-node-card-title-container w-100 g-pos-abs g-bottom-0 g-left-0 g-flex-middle g-bg-primary-opacity-0_9 opacity-0 g-opacity-1--parent-hover g-pa-20 g-transition-0_2 g-transition--ease-in">
						<h3 class="landing-block-node-card-title h3 g-color-white g-font-size-12">SWEET VALENTINE</h3>
						<div class="landing-block-node-card-subtitle g-color-white"> </div>
					</div>
				</div>
			</div>
			...
			<div class="landing-block-node-card text-center col-lg-3 col-md-4 col-sm-6 g-mb-30 js-animation slideInUp">
				<div class="g-pos-rel g-parent d-inline-block h-100">
					...
					<div class="landing-block-node-card-title-container w-100 g-pos-abs g-bottom-0 g-left-0 g-flex-middle g-bg-primary-opacity-0_9 opacity-0 g-opacity-1--parent-hover g-pa-20 g-transition-0_2 g-transition--ease-in">
						<h3 class="landing-block-node-card-title h3 g-color-white g-font-size-12">MUSICAL VALENTINE</h3>
						<div class="landing-block-node-card-subtitle g-color-white"> </div>
					</div>
				</div>
			</div>
		...
		<div class="row">
			<div class="landing-block-node-card col-lg-6 g-pl-100--md g-mb-30 js-animation slideInUp">
				<article class="landing-block-node-card-container media d-block d-md-flex h-100 g-bg-white">
					...
					<div class="media-body align-self-center g-py-50 g-pl-40 g-pl-0--md g-pr-40">
						<h3 class="landing-block-node-card-title h6 text-uppercase g-letter-spacing-4 g-font-weight-700 g-mb-20">FLOWERS WITH PLUSH</h3>
			...
			<div class="landing-block-node-card col-lg-6 g-pl-100--md g-mb-30 js-animation slideInUp">
				<article class="landing-block-node-card-container media d-block d-md-flex h-100 g-bg-white">
					...
					<div class="media-body align-self-center g-py-50 g-pl-40 g-pl-0--md g-pr-40">
						<h3 class="landing-block-node-card-title h6 text-uppercase g-letter-spacing-4 g-font-weight-700 g-mb-20">Photo sessions</h3>
						<div class="landing-block-node-card-text g-color-gray-dark-v5 mb-0">
			...
			<div class="landing-block-node-card col-lg-6 g-pl-100--md g-mb-30 js-animation slideInUp">
				<article class="landing-block-node-card-container media d-block d-md-flex h-100 g-bg-white">
					...
					<div class="media-body align-self-center g-py-50 g-pl-40 g-pl-0--md g-pr-40">
						<h3 class="landing-block-node-card-title h6 text-uppercase g-letter-spacing-4 g-font-weight-700 g-mb-20">FLOWER SETS</h3>
						<div class="landing-block-node-card-text g-color-gray-dark-v5 mb-0">
			...
			<div class="landing-block-node-card col-lg-6 g-pl-100--md g-mb-30 js-animation slideInUp">
				<article class="landing-block-node-card-container media d-block d-md-flex h-100 g-bg-white">
					...
					<div class="media-body align-self-center g-py-50 g-pl-40 g-pl-0--md g-pr-40">
						<h3 class="landing-block-node-card-title h6 text-uppercase g-letter-spacing-4 g-font-weight-700 g-mb-20">CANDIES AND PLUSH</h3>
						<div class="landing-block-node-card-text g-color-gray-dark-v5 mb-0">
			...
			<div class="landing-block-node-card col-lg-6 g-pl-100--md g-mb-30 js-animation slideInUp">
				<article class="landing-block-node-card-container media d-block d-md-flex h-100 g-bg-white">
					...
					<div class="media-body align-self-center g-py-50 g-pl-40 g-pl-0--md g-pr-40">
						<h3 class="landing-block-node-card-title h6 text-uppercase g-letter-spacing-4 g-font-weight-700 g-mb-20">ROMANTIC DINNER</h3>
						<div class="landing-block-node-card-text g-color-gray-dark-v5 mb-0">
			...
			<div class="landing-block-node-card col-lg-6 g-pl-100--md g-mb-30 js-animation slideInUp">
				<article class="landing-block-node-card-container media d-block d-md-flex h-100 g-bg-white">
					...
					<div class="media-body align-self-center g-py-50 g-pl-40 g-pl-0--md g-pr-40">
						<h3 class="landing-block-node-card-title h6 text-uppercase g-letter-spacing-4 g-font-weight-700 g-mb-20">CANDY SETS</h3>
						<div class="landing-block-node-card-text g-color-gray-dark-v5 mb-0">
				...
				<div class="h-100 g-pb-15 g-pb-0--sm">
					<div class="landing-block-node-img-container h-100 g-pos-rel g-parent u-block-hover">
						...
						<div class="landing-block-node-img-title-container w-100 g-pos-abs g-bottom-0 g-left-0 g-top-0
							...
							g-color-white g-line-height-1_4 g-letter-spacing-5 g-font-size-20">GIFT SET</h3>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="h-100 g-pb-0">
					<div class="landing-block-node-img-container h-100 g-pos-rel g-parent u-block-hover">
						...
						<div class="landing-block-node-img-title-container w-100 g-pos-abs g-bottom-0 g-left-0 g-top-0
							...
							<div class="h-100 g-flex-middle g-brd-around g-brd-white-opacity-0_2 text-uppercase">
								<h3 class="landing-block-node-img-title g-flex-middle-item text-center h3
							g-color-white g-line-height-1_4 g-letter-spacing-5 g-font-size-20">GIFT STE</h3>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="landing-block-node-card col-md-6 col-lg-4 g-mb-30 g-mb-0--md">
				...
				<article class="landing-block-node-card-container js-animation text-center text-uppercase g-theme-photography-bg-gray-dark-v2 g-color-white-opacity-0_5 fadeInRight">
					...
					<header class="g-letter-spacing-3 g-pos-rel g-px-40 g-mb-30">
						...
						<h4 class="landing-block-node-card-title h6 g-color-white g-mt-minus-25 g-mb-10">BIG random SET</h4>
			...
			<div class="landing-block-node-card col-md-6 col-lg-4 g-mb-30 g-mb-0--md">
				...
				<article class="landing-block-node-card-container text-center text-uppercase js-animation g-theme-photography-bg-gray-dark-v2 g-color-white-opacity-0_5 fadeInRight">
					...
					<header class="g-letter-spacing-3 g-pos-rel g-px-40 g-mb-30">
						...
						<h4 class="landing-block-node-card-title h6 g-color-white g-mt-minus-25 g-mb-10">paper valentines</h4>
						<div class="landing-block-node-card-text g-font-size-12 g-color-gray-dark-v4 mb-0">
			...
			<div class="landing-block-node-card col-md-6 col-lg-4 g-mb-30 g-mb-0--md">
				...
				<article class="landing-block-node-card-container text-center text-uppercase js-animation g-theme-photography-bg-gray-dark-v2 g-color-white-opacity-0_5 fadeInRight">
					...
					<header class="g-letter-spacing-3 g-pos-rel g-px-40 g-mb-30">
						...
						<h4 class="landing-block-node-card-title h6 g-color-white g-mt-minus-25 g-mb-10">BIG CANDY SET</h4>
