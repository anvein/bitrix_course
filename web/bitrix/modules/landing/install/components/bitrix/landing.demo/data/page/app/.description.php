...
return array(
	...
	'fields' => array(
		'ADDITIONAL_FIELDS' => array(
			'THEME_CODE' => 'app',
			'THEME_CODE_TYPO' => 'app',
			'METAOG_IMAGE' => 'https://repo.bitrix24.site/bitrix/images/demo/page/app/preview.jpg',
...
?>
<header id="js-header" class="landing-block landing-block-menu g-bg-white u-header u-header--sticky-top u-header--show-hide u-header--toggle-section" data-header-fix-moment="100" data-header-fix-effect="slide">
		...
		<nav class="navbar navbar-expand-lg py-0 g-px-15">
			<div class="container">
				...
				<a href="#" class="landing-block-node-menu-logo-link navbar-brand u-header__logo p-0">
					<img class="landing-block-node-menu-logo u-header__logo-img u-header__logo-img--main g-max-width-180" src="/bitrix/images/landing/logos/app-logo.png" width="131" alt="" />
				</a>
				<!-- End Logo -->
	...
	<div class="container">
		...
		<div id="carouselApp1" class="js-carousel js-gallery-cards landing-gallery-app-slider row g-pb-20" data-infinite="true" data-slides-show="3" data-slides-scroll="3" data-pagi-classes="text-center u-carousel-indicators-v1 g-absolute-centered--x g-bottom-0 g-wid">
				...
				<div class="align-self-center">
					...
					<div class="landing-block-node-card media d-block d-md-flex text-center text-md-left g-mb-30">
						<div class="d-md-flex align-self-center g-mb-30 g-mb-0--md g-mr-30--md">
							<span class="u-icon-v2 u-icon-size--lg g-font-size-26 g-color-primary g-rounded-50x">
	...
	<div class="container">
		<div class="text-uppercase g-line-height-1_3 g-mb-20">
			...
			<h2 class="landing-block-node-title g-font-size-36 mb-0 js-animation fadeIn">Have some <span style="font-weight: bold;">problems?</span>
			</h2>
		</div>
