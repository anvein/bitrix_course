...
return array(
	...
	'fields' => array(
		'ADDITIONAL_FIELDS' => array(
			...
			'METAOG_IMAGE' => 'https://repo.bitrix24.site/bitrix/images/demo/page/music/preview.jpg',
...
<header class="landing-block landing-block-menu g-bg-gray-dark-v1 u-header u-header--sticky-top u-header--change-appearance" data-header-fix-moment="600">
	<div class="u-header__section g-transition-0_3 g-py-16 g-py-10--md" data-header-fix-moment-classes="u-shadow-v27">
		<nav class="navbar navbar-expand-lg p-0 g-px-15">
			<div class="container">
				<!-- Logo -->
				<a href="#" class="navbar-brand landing-block-node-menu-logo-link u-header__logo" target="_self">
					<img class="landing-block-node-menu-logo u-header__logo-img u-header__logo-img--main g-max-width-180" src="/bitrix/images/landing/logos/music-logo.png" alt="" />
				</a>
				<!-- End Logo -->
...
></li>
						...
						<li class="nav-item landing-block-node-menu-list-item g-ml-15--lg">
							<a href="#block@block[33.3.form_1_transparent_black_no_text]" class="landing-block-node-menu-list-item-link nav-link p-0" target="_self">Contact</a>
						</li>
					</ul>
				</div>
				<!-- End Navigation -->
	...
	<div class="container u-bg-overlay__inner">
		...
		'36.2.concertes_dates_with_button' =>
			array (
				...
				'SORT' => '3000',
				'CONTENT' => '<section class="landing-block g-pb-100 g-bg-gray-light-v5 g-pt-20">
	<div class="container g-bg-gray-light-v5 g-font-size-13">
		<!-- Article -->
		<article class="landing-block-node-card js-animation d-md-table text-md-left text-center w-100 g-bg-white g-mb-1 fadeInUp">
			<!-- Date -->
			...
			<a href="#" class="d-md-table-cell g-valign-middle g-width-130">
				<img class="landing-block-node-card-img d-block info-v5-2__image g-ml-minus-1" src="https://cdn.bitrix24.site/bitrix/images/landing/business/600x600/img13.jpg" alt="" />
			</a>
			<!-- End Article Image -->
			...
			<div class="d-md-table-cell text-md-right g-valign-middle g-pa-20">
				<div class="g-mt-minus-10 g-mx-minus-5">
					<a class="landing-block-node-card-button btn btn-xl u-btn-primary rounded-0 text-uppercase g-font-weight-700 g-font-size-12 g-mx-5 g-mt-10" href="#">Buy Ticket</a>
				</div>
			</div>
			<!-- End Actions -->
		</article>
		...
		<article class="landing-block-node-card js-animation d-md-table text-md-left text-center w-100 g-bg-white g-mb-1 fadeInUp">
			...
			<!-- Article Image -->
			<a href="#" class="d-md-table-cell g-valign-middle g-width-130">
				<img class="landing-block-node-card-img d-block info-v5-2__image g-ml-minus-1" src="https://cdn.bitrix24.site/bitrix/images/landing/business/600x600/img14.jpg" alt="" />
			</a>
			<!-- End Article Image -->
		...
		<article class="landing-block-node-card js-animation d-md-table text-md-left text-center w-100 g-bg-white g-mb-1 fadeInUp">
			...
			<!-- Article Image -->
			<a href="#" class="d-md-table-cell g-valign-middle g-width-130">
				<img class="landing-block-node-card-img d-block info-v5-2__image g-ml-minus-1" src="https://cdn.bitrix24.site/bitrix/images/landing/business/600x600/img15.jpg" alt="" />
			</a>
			<!-- End Article Image -->
		...
		<article class="landing-block-node-card js-animation d-md-table text-md-left text-center w-100 g-bg-white g-mb-1 fadeInUp">
			...
			<!-- Article Image -->
			<a href="#" class="d-md-table-cell g-valign-middle g-width-130">
				<img class="landing-block-node-card-img d-block info-v5-2__image g-ml-minus-1" src="https://cdn.bitrix24.site/bitrix/images/landing/business/600x600/img16.jpg" alt="" />
			</a>
			<!-- End Article Image -->
			...
			<div class="landing-block-node-card-container js-animation fadeIn container text-center g-max-width-670">
				<div class="row justify-content-center g-mb-25">
					<img class="landing-block-node-card-photo g-brd-around g-height-50 g-width-50 g-brd-3
						 ...
						 src="https://cdn.bitrix24.site/bitrix/images/landing/business/100x100/img1.jpg" alt="Image descrition">
		...
		<div class="landing-block-node-card js-slide">
			<div class="landing-block-node-card-container js-animation fadeIn container text-center g-max-width-670">
				<div class="row justify-content-center g-mb-25">
					<img class="landing-block-node-card-photo g-brd-around g-height-50 g-width-50 g-brd-3
							g-brd-white-opacity-0_3 g-rounded-50x g-mr-20"
						 src="https://cdn.bitrix24.site/bitrix/images/landing/business/100x100/img2.jpg" alt="Image descrition">
	...
	<div class="container">
		...
		<div id="carouselCharity01" class="js-carousel g-pb-85 g-mx-minus-15" data-slides-show="2" data-arrows-classes="u-arrow-v1 g-pos-abs g-absolute-centered--x--md g-bottom-0 g-width-45 g-height-45 g-color-white g-color-black--hover g-bg-gray-light-v3 g-bg-primary--hover g-transition-0_2 g-transition--ease-in" data-arrow-left-classes="fa fa-chevron-left g-left-15 g-left-50x--md g-ml-minus-40--md" data-arrow-right-classes="fa fa-chevron-right g-right-15 g-left-50x--md g-ml-40--md">
			<div class="landing-block-node-card js-slide g-px-15">
				<!-- Article -->
				<article class="landing-block-node-card-bgimg clearfix g-bg-size-cover g-pos-rel" style="background-image: url(\'https://cdn.bitrix24.site/bitrix/images/landing/business/870x428/img1.jpg\');" data-fileid="-1" data-filehash="9eef207add73028ae50f74a9033c20cb">
					<!-- Article Content -->
					<div class="landing-block-node-card-text-bg float-right g-color-gray-light-v1 g-bg-black-opacity-0_7 g-width-50x--sm g-pa-30">
						...
						<a class="btn landing-block-node-card-button g-valign-middle btn-block text-uppercase g-font-weight-700 g-font-size-11 rounded-0 g-py-10 g-py-20--md g-px-15 g-px-25--md g-brd-primary u-btn-primary g-color-white js-animation fadeInLeft" href="#" target="_self">read more</a>
					</div>
					<!-- End Article Content -->
				</article>
				<!-- End Article -->
			...
			<div class="landing-block-node-card js-slide g-px-15">
				<!-- Article -->
				<article class="landing-block-node-card-bgimg clearfix g-bg-size-cover g-pos-rel" style="background-image: url(\'https://cdn.bitrix24.site/bitrix/images/landing/business/870x428/img2.jpg\');" data-fileid="-1" data-filehash="9eef207add73028ae50f74a9033c20cb">
					<!-- Article Content -->
					<div class="landing-block-node-card-text-bg float-right g-color-gray-light-v1 g-bg-black-opacity-0_7 g-width-50x--sm g-pa-30">
			...
			<div class="landing-block-node-card js-slide g-px-15">
				<!-- Article -->
				<article class="landing-block-node-card-bgimg clearfix g-bg-size-cover g-pos-rel" style="background-image: url(\'https://cdn.bitrix24.site/bitrix/images/landing/business/870x428/img3.jpg\');" data-fileid="-1" data-filehash="9eef207add73028ae50f74a9033c20cb">
					<!-- Article Content -->
					<div class="landing-block-node-card-text-bg float-right g-color-gray-light-v1 g-bg-black-opacity-0_7 g-width-50x--sm g-pa-30">
		...
		'33.3.form_1_transparent_black_no_text' =>
			array (
				...
				'SORT' => '6500',
				'CONTENT' => '<section
 class="landing-block g-pos-rel g-bg-primary-dark-v1 landing-block-node-bgimg g-bg-size-cover g-bg-img-hero g-bg-cover g-bg-black-opacity-0_7--after g-pt-60 g-pb-60" style="background-image: url(\'https://cdn.bitrix24.site/bitrix/images/landing/business/1900x1155/img1.jpg\');" data-fileid="-1">
...
>',
		...
		'35.2.footer_dark' =>
			array (
				...
				'SORT' => '7000',
				'CONTENT' => '<section class="g-color-gray-light-v1 g-pt-60 g-pb-60 g-bg-black">
	<div class="container">
		<div class="row">
			<div class="col-sm-12 col-md-6 col-lg-6 g-mb-25 g-mb-0--lg">
				<h2 class="landing-block-node-title text-uppercase g-color-white g-font-weight-700 g-font-size-16 g-mb-20">
					Contact us</h2>
				<div class="landing-block-node-text g-font-size-default g-color-gray-light-v1 g-mb-20"><p>Lorem ipsum
				...
				<address class="g-color-gray-light-v1 g-mb-20">
					...
					<div class="landing-block-card-contact g-pos-rel g-pl-20 g-mb-7">
						...
						<div>
							...
							<a href="tel:+48 555 2566 112" class="landing-block-node-card-contact-link g-font-weight-700 g-color-gray-light-v1">+48 555 2566 112</a>
						</div>
					</div>
					...
					<div class="landing-block-card-contact g-pos-rel g-pl-20 g-mb-7">
						...
						<div>
							...
							<a class="landing-block-node-card-contact-link g-color-gray-light-v1 g-font-weight-700" href="mailto:info@company24.com">info@company24.com</a>
						</div>
					</div>
				</address>
