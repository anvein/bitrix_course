...
<header class="landing-block landing-block-menu g-bg-white u-header u-header--floating g-z-index-9999">
				...
				<div class="collapse navbar-collapse align-items-center flex-sm-row" id="navBar">
					<ul class="landing-block-node-menu-list js-scroll-nav navbar-nav text-uppercase g-font-weight-700 g-font-size-12 g-pt-20 g-pt-0--lg ml-auto">
						<li class="landing-block-node-menu-list-item nav-item g-mr-10--lg g-mb-7 g-mb-0--lg active">
							<a href="#block@block[01.big_with_text_blocks]" class="landing-block-node-menu-list-item-link nav-link p-0 g-color-black g-font-roboto-slab" target="_self">Home</a><span class="sr-only">(current)
						</span></li>
						<li class="landing-block-node-menu-list-item nav-item g-mx-10--lg g-mb-7 g-mb-0--lg">
							<a href="#block@block[47.1.title_with_icon]" class="landing-block-node-menu-list-item-link nav-link p-0 g-color-black g-font-roboto-slab" target="_self">Products</a>
						</li>
						<li class="landing-block-node-menu-list-item nav-item g-mx-10--lg g-mb-7 g-mb-0--lg">
							<a href="#block@block[47.1.title_with_icon@2]" class="landing-block-node-menu-list-item-link nav-link p-0 g-color-black g-font-roboto-slab" target="_self">Our team</a>
						</li>
						<li class="landing-block-node-menu-list-item nav-item g-mx-10--lg g-mb-7 g-mb-0--lg">
							<a href="#block@block[27.one_col_fix_title_and_text_2]" class="landing-block-node-menu-list-item-link nav-link p-0 g-color-black g-font-roboto-slab" target="_self">Testimonials</a>
						</li>
						<li class="landing-block-node-menu-list-item nav-item g-mx-10--lg g-mb-7 g-mb-0--lg">
							<a href="#block@block[47.1.title_with_icon@3]" class="landing-block-node-menu-list-item-link nav-link p-0 g-color-black g-font-roboto-slab" target="_self">Specials</a>
						</li><li class="landing-block-node-menu-list-item nav-item g-mx-10--lg g-mb-7 g-mb-0--lg">
							<a href="#block@block[47.1.title_with_icon@4]" class="landing-block-node-menu-list-item-link nav-link p-0 g-color-black g-font-roboto-slab" target="_self">Contact</a>
						</li>
	...
	<div class="container">
		...
		'01.big_with_text_3' =>
			array (
				...
				'SORT' => '3000',
				'CONTENT' => '<section class="landing-block landing-block-node-img u-bg-overlay g-flex-centered g-min-height-100vh g-height-70vh g-bg-img-hero g-bg-black-opacity-0_5--after g-pb-70 g-pt-70" style="background-image: url(\'https://cdn.bitrix24.site/bitrix/images/landing/business/1000x669/img1.jpg\');" data-fileid="-1" data-filehash="9eef207add73028ae50f74a9033c20cb">
		...
		<div class="row">
			<div class="landing-block-node-card js-animation col-md-6 col-lg-6 g-pt-30 g-mb-50 g-mb-0--md fadeIn">
				...
				<article class="text-center">
					<!-- Article Image -->
					<img class="landing-block-node-card-photo g-max-width-200 g-rounded-50x g-mb-20" src="https://cdn.bitrix24.site/bitrix/images/landing/business/300x300/img1.jpg" alt="" data-fileid="-1" />
					<!-- End Article Image -->
			...
			<div class="landing-block-node-card js-animation col-md-6 col-lg-6 g-pt-30 g-mb-50 g-mb-0--md fadeIn">
				...
				<article class="text-center">
					<!-- Article Image -->
					<img class="landing-block-node-card-photo g-max-width-200 g-rounded-50x g-mb-20" src="https://cdn.bitrix24.site/bitrix/images/landing/business/300x300/img4.jpg" alt="" data-fileid="-1" />
					<!-- End Article Image -->
	...
	<div class="container text-center g-max-width-800">
		<div class="u-heading-v7-3 g-mb-30">
			<h2 class="landing-block-node-title u-heading-v7__title g-font-size-60 g-font-cormorant-infant font-italic g-font-weight-600 g-mb-20 js-animation fadeInUp">Speñial offers</h2>
