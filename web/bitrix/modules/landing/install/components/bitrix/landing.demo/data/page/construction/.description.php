...
return array(
	...
	'fields' => array(
		'ADDITIONAL_FIELDS' => array(
			...
			'METAOG_IMAGE' => 'https://repo.bitrix24.site/bitrix/images/demo/page/construction/preview.jpg',
...
?>
<header class="landing-block landing-block-menu g-bg-white u-header u-header--sticky-top u-header--change-appearance g-z-index-9999" data-header-fix-moment="100">
	<div class="u-header__section g-transition-0_3 g-py-12 g-py-20--md" data-header-fix-moment-exclude="g-py-20--md" data-header-fix-moment-classes="u-shadow-v27 g-py-15--md">
			...
			<div class="container">
				...
				<a href="#" class="landing-block-node-menu-logo-link navbar-brand u-header__logo p-0">
					<img class="landing-block-node-menu-logo u-header__logo-img u-header__logo-img--main g-max-width-180"
						 src="/bitrix/images/landing/logos/construction-logo.png"
						 alt="">
				</a>
				<!-- End Logo -->
				...
				<div class="collapse navbar-collapse align-items-center flex-sm-row" id="navBar">
					<ul class="landing-block-node-menu-list js-scroll-nav  navbar-nav text-uppercase g-font-weight-700 g-font-size-12 g-pt-20 g-pt-0--lg ml-auto">
						<li class="landing-block-node-menu-list-item nav-item g-mr-8--lg g-mb-7 g-mb-0--lg active">
							<a href="#block@block[01.two_col_with_titles]" class="landing-block-node-menu-list-item-link nav-link p-0 g-color-black" target="_self">HOME</a><span class="sr-only">(current)</span>
						</li>
						<li class="landing-block-node-menu-list-item nav-item g-mx-8--lg g-mb-7 g-mb-0--lg">
							<a href="#block@block[19.1.two_cols_fix_img_text_blocks]" class="landing-block-node-menu-list-item-link nav-link p-0 g-color-black" target="_self">ABOUT</a>
						</li>
						<li class="landing-block-node-menu-list-item nav-item g-mx-8--lg g-mb-7 g-mb-0--lg">
							<a href="#block@block[21.3.two_cols_big_bgimg_title_text_button]" class="landing-block-node-menu-list-item-link nav-link p-0 g-color-black" target="_self">SERVICES</a>
						</li>

						<li class="landing-block-node-menu-list-item nav-item g-mx-8--lg g-mb-7 g-mb-0--lg">
							<a href="#block@block[04.4.one_col_big_with_img]" class="landing-block-node-menu-list-item-link nav-link p-0 g-color-black" target="_self">RECENT PROJECTS</a>
						</li>
						<li class="landing-block-node-menu-list-item nav-item g-mx-8--lg g-mb-7 g-mb-0--lg">
							<a href="#block@block[04.7.one_col_fix_with_title_and_text_2@2]" class="landing-block-node-menu-list-item-link nav-link p-0 g-color-black" target="_self">TESTIMONIALS</a>
						</li>
						<li class="landing-block-node-menu-list-item nav-item g-mx-8--lg g-mb-7 g-mb-0--lg">
							<a href="#block@block[04.7.one_col_fix_with_title_and_text_2@3]" class="landing-block-node-menu-list-item-link nav-link p-0 g-color-black" target="_self">GALLERY</a>
						</li>
						<li class="landing-block-node-menu-list-item nav-item g-mx-8--lg g-mb-7 g-mb-0--lg">
							<a href="#block@block[04.7.one_col_fix_with_title_and_text_2@4]" class="landing-block-node-menu-list-item-link nav-link p-0 g-color-black" target="_self">CAREER</a>
						</li>
						<li class="landing-block-node-menu-list-item nav-item g-ml-8--lg">
							<a href="#block@block[04.7.one_col_fix_with_title_and_text_2@5]" class="landing-block-node-menu-list-item-link nav-link p-0 g-color-black" target="_self">CONTACT</a>
						</li>
					</ul>
				</div>
				<!-- End Navigation -->
			...
			<div class="landing-block-node-img col-md-6 u-bg-overlay g-bg-img-hero g-bg-black-opacity-0_7--after"
				...
				<div class="landing-block-node-inner-container g-flex-centered g-height-100vh--md g-min-height-300 g-py-40 g-pr-50--md text-md-right">
					<div class="landing-block-node-inner-container-left js-animation fadeInLeft w-100 u-bg-overlay__inner g-py-100">
						<h3 class="landing-block-node-small-title landing-block-node-small-title-left h4 g-font-weight-700 g-color-primary g-mb-20">We professionally do</h3>
			...
			<div class="landing-block-node-img col-md-6 u-bg-overlay g-bg-img-hero g-bg-black-opacity-0_7--after"
				...
				<div class="landing-block-node-inner-container g-flex-centered g-height-100vh--md g-min-height-300 g-py-40 g-pl-50--md">
					<div class="landing-block-node-inner-container-right js-animation fadeInRight w-100 u-bg-overlay__inner g-py-100">
						<h3 class="landing-block-node-small-title landing-block-node-small-title-right h4 g-font-weight-700 g-color-primary g-mb-20">We professionally do</h3>
	...
	<div class="container text-center text-lg-left g-color-white">
		<div class="row g-flex-centered">
			...
			<a class="landing-block-node-button js-animation fadeInUp btn btn-lg u-btn-inset mx-2 g-flex-centered g-flex-right--lg animated" href="#">
				Get a quote
			</a>
		</div>
	</div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-5 g-mb-30 g-mb-0--md">
                    ...
                    <h3 class="landing-block-node-title text-uppercase g-font-weight-700 g-font-size-18 g-color-black g-mb-20">Building since 1943</h3>
                ...
                <div class="col-md-7">
                    <div aria-multiselectable="true">
                        <div class="landing-block-card-accordeon-element card g-brd-none js-animation fadeInUp animated landing-card">
                            <div class="card-header u-accordion__header g-bg-transparent g-brd-none rounded-0 p-0">
								<div class="landing-block-card-accordeon-element-title-link d-block text-uppercase g-pos-rel g-font-weight-700 g-font-size-12 g-brd-bottom g-brd-primary g-brd-2 g-py-15">
                                    <i class="landing-block-node-accordeon-element-img icon-user g-valign-middle g-font-size-23 g-color-primary g-mr-10"></i>
                            ...
                            <div class="landing-block-card-accordeon-element-body" aria-labelledby="aboutAccordionHeading1">
                                <div class="card-block u-accordion__body g-py-20 px-0">
                                    <div class="landing-block-node-accordeon-element-text g-color-gray-dark-v5">
										<p class="g-font-size-default mb-0">Anim pariatur cliche reprehenderit, 3 wolf moon officia aute, non cupidatat skateboard dolor brunch. Food truck quinoa nesciunt laborum eiusmod.
                        ...
                        <div class="landing-block-card-accordeon-element card g-brd-none js-animation fadeInUp animated landing-card">
                            <div class="card-header u-accordion__header g-bg-transparent g-brd-none rounded-0 p-0">
                                <div class="landing-block-card-accordeon-element-title-link d-block text-uppercase g-pos-rel g-font-weight-700 g-font-size-12 g-brd-bottom g-brd-primary g-brd-2 g-py-15">
                                    <i class="landing-block-node-accordeon-element-img icon-calendar g-valign-middle g-font-size-23 g-color-primary g-mr-10"></i>
                            ...
                            <div class="landing-block-card-accordeon-element-body" aria-labelledby="aboutAccordionHeading2">
                                <div class="card-block u-accordion__body g-py-20 px-0">
                                    <div class="landing-block-node-accordeon-element-text g-color-gray-dark-v5">
										<p class="g-font-size-default mb-0">Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus terry richardson ad squid. Food truck quinoa nesciunt laborum eiusmod. Duis aute
                        ...
                        <div class="landing-block-card-accordeon-element card g-brd-none js-animation fadeInUp animated landing-card">
                            <div class="card-header u-accordion__header g-bg-transparent g-brd-none rounded-0 p-0">
                                <div class="landing-block-card-accordeon-element-title-link d-block text-uppercase g-pos-rel g-font-weight-700 g-font-size-12 g-brd-bottom g-brd-primary g-brd-2 g-py-15">
                                    <i class="landing-block-node-accordeon-element-img icon-settings g-valign-middle g-font-size-23 g-color-primary g-mr-10"></i>
                            ...
                            <div class="landing-block-card-accordeon-element-body" aria-labelledby="aboutAccordionHeading3">
                                <div class="card-block u-accordion__body g-py-20 px-0">
                                    <div class="landing-block-node-accordeon-element-text g-color-gray-dark-v5">
										<p class="g-font-size-default mb-0">3 wolf moon officia aute, non cupidatat skateboard dolor brunch. Food truck quinoa nesciunt laborum eiusmod. At vero eos et accusamus et iusto odio
                        ...
                        <div class="landing-block-card-accordeon-element card g-brd-none js-animation fadeInUp animated landing-card">
                            <div class="card-header u-accordion__header g-bg-transparent g-brd-none rounded-0 p-0">
                                <div class="landing-block-card-accordeon-element-title-link d-block text-uppercase g-pos-rel g-font-weight-700 g-font-size-12 g-brd-bottom g-brd-primary g-brd-2 g-py-15">
                                    <i class="landing-block-node-accordeon-element-img icon-diamond g-valign-middle g-font-size-23 g-color-primary g-mr-10"></i>
                            ...
                            <div class="landing-block-card-accordeon-element-body" aria-labelledby="aboutAccordionHeading4">
                                <div class="card-block u-accordion__body g-py-20 px-0">
                                    <div class="landing-block-node-accordeon-element-text g-color-gray-dark-v5">
										<p class="g-font-size-default mb-0">Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus terry richardson ad squid. 3 wolf moon officia aute, non cupidatat skateboard
        ...
        <div class="row no-gutters g-overflow-hidden">
				...
				justify-content-center u-bg-overlay g-transition--ease-in g-transition-0_2 g-transform-scale-1_03--hover"
					...
					<div class="text-center u-bg-overlay__inner g-pa-40">
						...
						<div class="landing-block-node-button-container">
							<a class="landing-block-node-button js-animation fadeIn btn btn-lg u-btn-inset mx-2" href="#">
								Read more
							</a>
						</div>
					</div>
				...
				<div class="landing-block-card col-lg-6 landing-block-node-img g-min-height-500 g-bg-img-hero row no-gutters align-items-center
					justify-content-center g-bg-black-opacity-0_6--after u-bg-overlay g-transition--ease-in g-transition-0_2 g-transform-scale-1_03--hover"
        ...
        <div class="row no-gutters g-overflow-hidden">
				<div class="landing-block-card col-lg-6 landing-block-node-img g-min-height-500 g-bg-black-opacity-0_6--after g-bg-img-hero row no-gutters align-items-center
				justify-content-center u-bg-overlay g-transition--ease-in g-transition-0_2 g-transform-scale-1_03--hover" style="background-image: url(\'https://cdn.bitrix24.site/bitrix/images/landing/business/900x506/img3.jpg\');" data-fileid="-1">
					<div class="text-center u-bg-overlay__inner g-pa-40">
				...
				<div class="landing-block-card col-lg-6 landing-block-node-img g-min-height-500 g-bg-img-hero row no-gutters align-items-center
					justify-content-center g-bg-black-opacity-0_6--after u-bg-overlay g-transition--ease-in g-transition-0_2 g-transform-scale-1_03--hover" style="background-image: url(\'https://cdn.bitrix24.site/bitrix/images/landing/business/900x506/img4.jpg\');" data-fileid="-1">
					<div class="text-center u-bg-overlay__inner g-pa-40">
	...
	<div class="container text-center g-max-width-800 g-mb-20">
		...
		<div class="landing-block-node-inner text-uppercase u-heading-v2-4--bottom g-brd-primary">
			...
			<h2 class="landing-block-node-title u-heading-v2__title g-line-height-1_1 g-font-weight-700 g-font-size-40 g-color-black g-mb-minus-10">What we can do</h2>
		</div>

		<div class="landing-block-node-text g-color-gray-dark-v5 g-pb-1">
	...
	<div class="container">
		<div class="row">
			...
			<div class="landing-block-card js-animation fadeInUp landing-block-node-block col-md-3 g-mb-30 g-mb-0--md g-pt-10">
				...
				<h3 class="landing-block-node-title text-uppercase g-font-weight-700 g-font-size-18 g-color-black g-mb-20">SAEPE EVENIET UT</h3>
			...
			<div class="landing-block-card js-animation fadeInUp landing-block-node-block col-md-3 g-mb-30 g-mb-0--md g-pt-10">
				...
				<h3 class="landing-block-node-title text-uppercase g-font-weight-700 g-font-size-18 g-color-black g-mb-20">VOLUPTATE VELIT ESSE</h3>
				<div class="landing-block-node-text"><p>Itaque earum rerum hic tenetur a sapiente delectus, ut aut reiciendis voluptatibus maiores alias consequatur aut perferendis doloribus asperiores repellat.</p></div>
			</div>
			...
			<div class="landing-block-card js-animation fadeInUp landing-block-node-block col-md-3 g-mb-30 g-mb-0--md g-pt-10">
				...
				<h3 class="landing-block-node-title text-uppercase g-font-weight-700 g-font-size-18 g-color-black g-mb-20">TEMPORIBUS AUTEM</h3>
				<div class="landing-block-node-text"><p>Itaque earum rerum hic tenetur a sapiente delectus, ut aut reiciendis voluptatibus maiores alias consequatur aut perferendis doloribus asperiores repellat.</p></div>
			</div>
			...
			<div class="landing-block-card js-animation fadeInUp landing-block-node-block col-md-3 g-mb-30 g-mb-0--md g-pt-10">
				...
				<h3 class="landing-block-node-title text-uppercase g-font-weight-700 g-font-size-18 g-color-black g-mb-20">QUIBUSDAM</h3>
				<div class="landing-block-node-text"><p>Itaque earum rerum hic tenetur a sapiente delectus, ut aut reiciendis voluptatibus maiores alias consequatur aut perferendis doloribus asperiores repellat.</p></div>
			</div>
        ...
        <div class="container u-bg-overlay__inner">
            <div class="row">
                ...
                <div class="landing-block-card d-flex flex-column col-md-4 g-mb-20 g-mb-0--md js-animation fadeIn animated landing-card">
                    <div class="u-heading-v8-1 g-mb-20">
                        <h2 class="landing-block-node-subtitle h6 text-uppercase u-heading-v8__title g-font-weight-700 g-color-white mb-0 g-font-size-11 g-color-white-opacity-0_8 p-0 g-mb-7">
                            Building
						</h2>
						<h2 class="landing-block-node-title h6 text-uppercase u-heading-v8__title g-font-weight-700 g-color-white mb-0 g-font-size-15">
                            Excepteur sint occaecat cupidatat
						</h2>
                    </div>
                    <img class="landing-block-node-img img-fluid g-mb-20" src="https://cdn.bitrix24.site/bitrix/images/landing/business/1000x565/img1.jpg" alt="" />
                    <div class="landing-block-node-text g-line-height-1_8 g-font-size-default g-color-white-opacity-0_8 g-mb-40 g-font-size-14">
                    ...
                    <div class="landing-block-node-button-container mt-auto">
						<a class="landing-block-node-button btn btn-lg u-btn-inset" href="#">
							View project
						</a>
					</div>
                </div>
                ...
                <div class="landing-block-card d-flex flex-column col-md-4 g-mb-20 g-mb-0--md js-animation fadeIn animated landing-card">
                    ...
                    <img class="landing-block-node-img img-fluid g-mb-20" src="https://cdn.bitrix24.site/bitrix/images/landing/business/1000x565/img2.jpg" alt="" />
                    <div class="landing-block-node-text g-line-height-1_8 g-font-size-default g-color-white-opacity-0_8 g-mb-40 g-font-size-14">
						<p>Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur, sunt in culpa qui officia deserunt mollit
							anim id est laborum.</p>
					</div>
                ...
                <div class="landing-block-card d-flex flex-column col-md-4 g-mb-20 g-mb-0--md js-animation fadeIn animated landing-card">
                    ...
                    <img class="landing-block-node-img img-fluid g-mb-20" src="https://cdn.bitrix24.site/bitrix/images/landing/business/1000x565/img3.jpg" alt="" />
                    <div class="landing-block-node-text g-line-height-1_8 g-font-size-default g-color-white-opacity-0_8 g-mb-40 g-font-size-14">
						<p>Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur, sunt in culpa qui officia deserunt mollit
							anim id est laborum.</p>
					</div>
	...
	<div class="container text-center g-max-width-800 g-mb-20">
		...
		<div class="landing-block-node-inner text-uppercase u-heading-v2-4--bottom g-brd-primary">
			<h4 class="landing-block-node-subtitle g-font-weight-700 g-font-size-12 g-color-primary g-mb-15">
				Testimonials</h4>
			<h2 class="landing-block-node-title u-heading-v2__title g-line-height-1_1 g-font-weight-700 g-font-size-40 g-color-black g-mb-minus-10">
				What clients say</h2>
		</div>
		...
		'24.2.image_carousel_6_cols_fix_3' =>
			array (
				...
				'SORT' => '6000',
				'CONTENT' => '<section class="landing-block js-animation landing-block-node-bgimg g-bg-img-hero u-bg-overlay g-pt-60 g-py-80 fadeIn animated g-bg-primary-opacity-0_8--after" style="background-image: url(https://cdn.bitrix24.site/bitrix/images/landing/business/1920x350/img1.jpg);">
	<div class="container u-bg-overlay__inner text-center">
		<div id="carouselGLR004" class="js-carousel" data-autoplay="true" data-infinite="true" data-slides-show="6">
	...
	<div class="container text-center g-max-width-800 g-mb-20">
		...
		<div class="landing-block-node-inner text-uppercase u-heading-v2-4--bottom g-brd-primary">
			...
			<h2 class="landing-block-node-title u-heading-v2__title g-line-height-1_1 g-font-weight-700 g-font-size-40 g-color-black g-mb-minus-10">Our works</h2>
		</div>
	...
	<div class="row no-gutters js-gallery-cards">
        ...
        <div class="container landing-block-node-subcontainer text-center g-max-width-800 g-mb-20">
            ...
            <div class="landing-block-node-inner text-uppercase u-heading-v2-4--bottom g-brd-primary">
                ...
                <h2 class="landing-block-node-title u-heading-v2__title g-line-height-1_1 g-font-weight-700 g-font-size-40 g-color-black g-mb-minus-10">WORK WITH US</h2>
            </div>
                ...
                <div class="js-carousel" data-infinite="true" data-arrows-classes="u-arrow-v1 g-pos-abs g-absolute-centered--y--md g-top-0 g-top-50x--md g-width-50 g-height-50 g-font-size-default g-color-primary g-bg-gray-dark-v1 g-opacity-0_8--hover g-transition-0_2 g-transition--ease-in" data-arrow-left-classes="fa fa-arrow-left g-left-0 g-ml-30--md" data-arrow-right-classes="fa fa-arrow-right g-right-0 g-mr-30--md">
                    <div class="landing-block-card-slider-element js-slide">
                        <div class="container text-center g-max-width-700">
							...
							<div class="landing-block-node-button-container">
								<a class="landing-block-node-element-button btn btn-lg u-btn-inset js-animation fadeInUp" href="#">
									Submit resume
								</a>
                            </div>
                        </div>
        ...
        <div class="container landing-block-node-subcontainer text-center g-max-width-800 g-mb-20">
            ...
            <div class="landing-block-node-inner text-uppercase u-heading-v2-4--bottom g-brd-primary">
                ...
                <h2 class="landing-block-node-title u-heading-v2__title g-line-height-1_1 g-font-weight-700 g-font-size-40 g-color-black g-mb-minus-10">get in touch</h2>
            </div>
		...
		'33.10.form_2_light_left_text' =>
			array (
				...
				'SORT' => '10000',
				'CONTENT' => '<section class="g-pos-rel landing-block text-center g-color-gray-dark-v1 g-py-100 g-pt-20">
						...
						<div class="row mx-0">
							<div class="landing-block-card-contact col-sm-6 g-brd-left g-brd-bottom g-brd-gray-light-v4 g-px-15 g-py-25 js-animation fadeIn animated landing-card">
								...
								<h3 class="landing-block-card-contact-title text-uppercase g-font-size-11 g-color-gray-dark-v5 mb-0" data-form-style-label-font-weight="1" data-form-style-label-font-size="1" data-form-style-second-font-color="1">
									Address</h3>
								<div class="landing-block-card-contact-text g-font-size-11" data-form-style-main-font-color="1">
							...
							<div class="landing-block-card-contact col-sm-6 g-brd-left g-brd-bottom g-brd-gray-light-v4 g-px-15 g-py-25 js-animation fadeIn animated landing-card">
								...
								<h3 class="landing-block-card-contact-title text-uppercase g-font-size-11 g-color-gray-dark-v5 mb-0" data-form-style-label-font-weight="1" data-form-style-label-font-size="1" data-form-style-second-font-color="1">
									Email</h3>
								<div class="g-font-size-11 g-color-gray-dark-v1" data-form-style-main-font-color="1">
		...
		<div class="container text-center text-md-left u-bg-overlay__inner">
			<div class="row">
				<div class="col-md-4 col-lg-5 d-flex align-items-center g-mb-20 g-mb-0--md">
					<p class="w-100 g-font-size-13 g-color-white mb-0 landing-block-node-copy">&copy; 2018 All right reserved</p>
				</div>
